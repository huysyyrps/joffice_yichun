...
public class HRecyclerView1 extends RelativeLayout {
    ...
    public HRecyclerView1(Context context) {
        this(context, null);
    }

    public HRecyclerView1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HRecyclerView1(Context context, AttributeSet attrs, int defStyleAttr) {
