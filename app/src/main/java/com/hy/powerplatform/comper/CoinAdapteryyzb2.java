...
public class CoinAdapteryyzb2 extends CommonAdapter<CLQK> {


    public CoinAdapteryyzb2(Context context, List<CLQK> dataList, int layoutId, CommonViewHolder.onItemCommonClickListener listener) {
        super(context, dataList, layoutId);
    }

    @Override
    public void bindData(CommonViewHolder holder, CLQK data, int position) {
