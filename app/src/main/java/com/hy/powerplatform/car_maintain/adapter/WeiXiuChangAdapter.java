...
public class WeiXiuChangAdapter extends RecyclerView.Adapter<WeiXiuChangAdapter.ViewHolder> {
    Context context;
    ...
    public WeiXiuChangAdapter(Context context, List<String> dataList) {
