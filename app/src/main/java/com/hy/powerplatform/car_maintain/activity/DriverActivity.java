...
public class DriverActivity extends BaseActivity implements DriverView,DriverAdapter.CallBackPosition {
    ...
    public void getDriverView(Driver driver) {
        ...
        DriverAdapter adapter = new DriverAdapter(DriverActivity.this, dataList);
    ...
    public void myTextViewClient(int position) {
        Intent i = new Intent();
        i.putExtra("driver", dataList.get(position));
