...
public class MainShenYanActivity extends BaseActivity {
...
//        webView.loadDataWithBaseURL(null, tpl, "text/html", "utf-8", null);
      //  webView.loadUrl("http://58.17.74.135:6770/muiH/view/repair-check.html");
        webView.loadUrl(contantdata.url+"/muiH/view/repair-check.html");
