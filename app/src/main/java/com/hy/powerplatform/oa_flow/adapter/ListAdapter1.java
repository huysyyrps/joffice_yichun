...
public class ListAdapter1  extends RecyclerView.Adapter<ListAdapter1.ViewHolder> {
    ...
    List<WillDoNum.ResultBean> numList = new ArrayList<>();
    Context context;
    public ListAdapter1(FragmentActivity context, List<String> beanList, List<WillDoNum.ResultBean> numList) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent;
                if (position == 0){
                    intent = new Intent(context, MyWillDoActivity.class);
