...
import com.hy.powerplatform.oa_flow.fragment.FragmentRepairData;
import com.hy.powerplatform.oa_flow.fragment.FragmentRepairList;
...
public class FlowRepairActivity extends BaseActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        header.setTvTitle("报修项目登记表");
        fragment01 = new FragmentRepairData();
        fragment02 = new FragmentRepairList();
