...
import com.hy.powerplatform.oa_flow.fragment.FragmentContractPayData;
import com.hy.powerplatform.oa_flow.fragment.FragmentContractPayList;
 ...
 * 合同付款审批
 */
public class FlowContractPayActivity extends BaseActivity implements RadioGroup.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        header.setTvTitle("合同付款单");
        fragment01 = new FragmentContractPayData();
        fragment02 = new FragmentContractPayList();
