    ...
    protected void rightClient() {
        ...
        tv_yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (str.equals("")) {
                    Toast.makeText(FlowDormWillDetailActivity.this, getResources().getString(R.string.nullify_reason), Toast.LENGTH_SHORT).show();
                } else {
                    dialog.dismiss();
                    ProgressDialogUtil.startLoad(FlowDormWillDetailActivity.this, getResources().getString(R.string.get_data));
...
//                }
    ...
    @OnClick({R.id.btnUp, R.id.tvStartTime, R.id.tvEndTime, R.id.tvData, R.id.btnT, R.id.btnHistory, R.id.llShenPiRen})
...
//                    }
                ...
                if (zlfsqreout.equals("2")) {
                    if (etHome.getText().toString().equals("")) {
                        Toast.makeText(this, "房间号不能为空", Toast.LENGTH_SHORT).show();
                        break;
                    }
                    if (etChuangHao.getText().toString().equals("")) {
                        Toast.makeText(this, "床号不能为空", Toast.LENGTH_SHORT).show();
                        break;
                    }
                }
                if (comment.equals("")) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (bigResultList.size() == 0 && bigResultList1.size() != 0) {
                    Looper.prepare();
                    ProgressDialogUtil.stopLoad();
                    Toast.makeText(FlowDormWillDetailActivity.this, "请选择审批人", Toast.LENGTH_SHORT).show();
                    Looper.loop();
                } else {
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 333:
                    ProgressDialogUtil.stopLoad();
                    Toast.makeText(FlowDormWillDetailActivity.this, getResources().getString(R.string.c_success), Toast.LENGTH_SHORT).show();
                    finish();
                    break;
                case 444:
                    ProgressDialogUtil.stopLoad();
                    Toast.makeText(FlowDormWillDetailActivity.this, getResources().getString(R.string.c_false), Toast.LENGTH_SHORT).show();
                    break;
                case 111:
                    Gson gsonF = new Gson();
                ...
                case TAG_ONE:
                    ...
                    if (bzyj != null && !bzyj.equals("")) {
                        ...
                        if (tvLeader3.getVisibility() == View.VISIBLE) {
                            tvLeader3.setText(word5);
                            etLeader3.setHint(word5);
                        } else {
                            etLeader3.setHint(word5);
                        }
                    }else {
                    ...
                    if (bmfzryj != null && !bmfzryj.equals("")) {
                        ...
                        if (tvLeader.getVisibility() == View.VISIBLE) {
                            tvLeader.setText(word2);
                            etLeader.setHint(word2);
                        } else {
                            etLeader.setHint(word2);
                        }
                    }else {
                    ...
                    if (zlfsqyj != null && !zlfsqyj.equals("")) {
                    }else {
                    ...
                    try {
                        ...
                        if (bmreout.equals("1") && wyreout.equals("1") && blrzreout.equals("1")
                                && cwsgreout.equals("1") && zlfsqreout.equals("1") && bzreout.equals("1")) {
                            Toast.makeText(FlowDormWillDetailActivity.this, "您对当前流程只有读取权限", Toast.LENGTH_SHORT).show();
                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                    ...
                    if (bean.isRevoke()) {
                        Toast.makeText(FlowDormWillDetailActivity.this, "当前流程已被追回", Toast.LENGTH_SHORT).show();
                    }
                    ProgressDialogUtil.stopLoad();
                    if (beanList.size() == 1) {
                        btnT.setVisibility(View.GONE);
                        tvText.setVisibility(View.GONE);
                        ProgressDialogUtil.startLoad(FlowDormWillDetailActivity.this, "获取审核人");
                        getAppRovePerson();
                    } else {
                    ...
                    break;
                case TAG_TWO:
                    Toast.makeText(FlowDormWillDetailActivity.this, "操作失败", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_THERE:
