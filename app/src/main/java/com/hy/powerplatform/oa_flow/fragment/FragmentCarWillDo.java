...
import com.hy.powerplatform.oa_flow.activity.FlowUseCarWillDetailActivity;
...
public class FragmentCarWillDo extends Fragment implements FlowQingJiaWillDoAdapter.OnGetAdapterPositionListener,Runnable {
...
//        recyclerView.setLoadMoreEnable(false);
    ...
    public void run() {
        String url = Constant.BASE_URL2 + Constant.WILLDOLIST + start + "&limit="
                + limit+"&Q_subject_S_LK="+Constant.USERCARNAME;
    ...
    public void getAdapterPosition(int position) {
        Intent intent = new Intent(getActivity(), FlowUseCarWillDetailActivity.class);
