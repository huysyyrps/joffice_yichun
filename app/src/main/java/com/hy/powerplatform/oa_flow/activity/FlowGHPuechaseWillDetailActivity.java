...
import com.hy.powerplatform.oa_flow.bean.FlowGHWillPurchase;
...
public class FlowGHPuechaseWillDetailActivity extends BaseActivity {
    ...
    String tag = "noEnd";
    String comment = "";
    String bmreout, zcreout, fgreout, zxreout, zjlreout, flowAssignld, serialNumber = "";
    ...
    List<FlowGHWillPurchase.TransBean> beanList = new ArrayList<>();
...
//        });
    ...
    protected int provideContentViewId() {
        return R.layout.activity_ghpurchase_will;
    }
...
//                res = dbA.OAQingJiaWillDoDex(url);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnUp:
                ...
                fgldyj = bean.getMainform().get(0).getCwzjyj();
                ghzx = bean.getMainform().get(0).getGhzx();
                userName = new SharedPreferencesHelper(FlowGHPuechaseWillDetailActivity.this,
                        "login").getData(FlowGHPuechaseWillDetailActivity.this, "userStatus", "");
                userCode = new SharedPreferencesHelper(FlowGHPuechaseWillDetailActivity.this,
                        "login").getData(FlowGHPuechaseWillDetailActivity.this, "userId", "");
                ...
                if (etLeader2.getVisibility() == View.VISIBLE) {
                    ...
                    jsonArray.put(jsonObject);
                    if (ghzx.equals("")) {
                        ghzx = jsonArray.toString();
                    } else {
                        ghzx = ghzx + "," + jsonArray.toString();
                        ghzx = ghzx.toString().replace("],[", ",");
                    }
                }
                if (comment.equals("")) {
        ...
        if (bigResultList.size() != 0) {
            ...
            if (btnT.getVisibility() == View.VISIBLE) {
                if (btnTTag.equals("N")) {
                    ...
                    FlowGHWillPurchase bean = gson.fromJson(res, FlowGHWillPurchase.class);
                    bmfzryj = bean.getMainform().get(0).getBmfzryj();
                    zcgkbmyj = bean.getMainform().get(0).getGhzx();
                    fgldyj = bean.getMainform().get(0).getCwzjyj();
    ...
    private void sendData() {
        ProgressDialogUtil.startLoad(FlowGHPuechaseWillDetailActivity.this, "提交数据中");
        new Thread(new Runnable() {
            @Override
            public void run() {
                ...
                final String userCode = new SharedPreferencesHelper(FlowGHPuechaseWillDetailActivity.this,
                        "login").getData(FlowGHPuechaseWillDetailActivity.this, "userCode", "");
                if (codetemp != null) {
                ...
                if (bigResultList.size() == 0 && bigResultList1.size() != 0) {
                    Looper.prepare();
                    ProgressDialogUtil.stopLoad();
                    Toast.makeText(FlowGHPuechaseWillDetailActivity.this, "请选择审批人", Toast.LENGTH_SHORT).show();
                    Looper.loop();
                } else {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 111:
                    ...
                    adapter = new FlowMessageAdapter(FlowGHPuechaseWillDetailActivity.this, flowList);
                ...
                case TAG_ONE:
                    ...
                    if (res.equals("false")) {
                        ...
                        try {
                            ...
                            fgreout = jsonObject.getString("cwzjyj");
                            zxreout = jsonObject.getString("ghzx");
                            if (bmreout.equals("2")) {
                ...
                case TAG_TWO:
                    ...
                    break;
                case TAG_THERE:
                    Toast.makeText(FlowGHPuechaseWillDetailActivity.this, "提交数据成功", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    finish();
                    break;
                case TAG_FOUR:
                ...
                case TAG_SEVEN:
                    ...
                    break;
                case TAG_EIGHT:
                    Toast.makeText(FlowGHPuechaseWillDetailActivity.this, "流程已到最后一步，请提交", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_NINE:
                    Gson gson2 = new Gson();
