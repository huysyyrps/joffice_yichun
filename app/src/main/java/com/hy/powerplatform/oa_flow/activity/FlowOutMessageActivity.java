...
import com.hy.powerplatform.oa_flow.fragment.FragmentOutMessageData;
import com.hy.powerplatform.oa_flow.fragment.FragmentOutMessageList;
 ...
 * 集团发文审批
 */
public class FlowOutMessageActivity extends BaseActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        header.setTvTitle("集团发文审批");
        fragment01 = new FragmentOutMessageData();
        fragment02 = new FragmentOutMessageList();
