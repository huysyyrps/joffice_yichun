...
import com.hy.powerplatform.oa_flow.metting.bean.MyWillOpenList;
...
public class MyWillOpenListActivity extends BaseActivity {
    ...
    List<MyWillOpenList.ResultBean> beanList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        baseAdapter = new BaseRecyclerAdapter<MyWillOpenList.ResultBean>(this, R.layout.adapter_rzlist_item, beanList) {
            @Override
            public void convert(BaseViewHolder holder, final MyWillOpenList.ResultBean resultBean) {
                ...
                holder.setOnClickListener(R.id.ll, new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(MyWillOpenListActivity.this, MyWillOpenDetailActivity.class);
    ...
    private void getData(final int start, final int limit) {
        ...
        final String path_url = Constant.BASE_URL2 + Constant.MYWILLOPEN + "?start=" + start + "&limit=" + limit;
        map.clear();
        map.put("sort", "confId");
        map.put("dir", "DESC");
        ...
        customDatePicker1 = new CustomDatePickerDay(this, new CustomDatePickerDay.ResultHandler() {
            ...
            public void handle(String time) { // 回调接口，获得选中的时间
                if (sendHttpContent(time.split(" ")[0])) {
                    ...
                    Toast.makeText(MyWillOpenListActivity.this, "请选择正确时间", Toast.LENGTH_SHORT).show();
                }
            }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case TAG_ONE:
                    ...
                    Toast.makeText(MyWillOpenListActivity.this, message, Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_TWO:
                    Bundle b1 = msg.getData();
                    String data = b1.getString("data");
                    MyWillOpenList bean = new Gson().fromJson(data, MyWillOpenList.class);
