    ...
    protected void rightClient() {
        ...
        tv_yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (str.equals("")) {
                    Toast.makeText(FlowChuCaiWillDetailActivity.this, getResources().getString(R.string.nullify_reason), Toast.LENGTH_SHORT).show();
                } else {
                    dialog.dismiss();
                    ProgressDialogUtil.startLoad(FlowChuCaiWillDetailActivity.this, getResources().getString(R.string.get_data));
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnUp:
                ...
                if (comment.equals("")) {
                    if ( !fgreout.equals("2") && !cwzjreout.equals("2") && !zjlreout.equals("2")) {
                        comment = "";
                        personSession();
                ...
                case TAG_ONE:
                    ...
                    try {
                        ...
                        if (cwzjreout.equals("2")) {
                            ...
                            llLeaderCWZJ.setVisibility(View.VISIBLE);
                        } else {
                    ...
                    break;
                case TAG_TWO:
                    Toast.makeText(FlowChuCaiWillDetailActivity.this, "操作失败", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_THERE:
