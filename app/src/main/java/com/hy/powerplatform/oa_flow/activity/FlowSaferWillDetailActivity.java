...
import com.hy.powerplatform.oa_flow.bean.FlowSaferWillDetail;
...
public class FlowSaferWillDetailActivity extends BaseActivity {
    ...
    String tag = "noEnd";
    String comment = "";
    String bmreout = "", fgreout = "", cwreout = "", flowAssignld, serialNumber = "";
    ...
    List<FlowSaferWillDetail.TransBean> beanList = new ArrayList<>();
    ...
    protected int provideContentViewId() {
        return R.layout.activity_safe_data;
    }
    ...
    protected void rightClient() {
        ...
        tv_yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (str.equals("")) {
                    Toast.makeText(FlowSaferWillDetailActivity.this, getResources().getString(R.string.nullify_reason), Toast.LENGTH_SHORT).show();
                } else {
                    dialog.dismiss();
                    ProgressDialogUtil.startLoad(FlowSaferWillDetailActivity.this, getResources().getString(R.string.get_data));
...
//                res = dbA.OAQingJiaWillDoDex(url);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnHistory:
                ...
                ProgressDialogUtil.startLoad(FlowSaferWillDetailActivity.this, "获取数据中");
                new Thread(new Runnable() {
                    @Override
                    public void run() {
            ...
            case R.id.btnT:
                ...
                if (beanList.size() != 0) {
                    if (beanList.size() == 1) {
                        ...
                        MyAlertDialog.MyListAlertDialog(FlowSaferWillDetailActivity.this, namelist, new AlertDialogCallBackP() {
                            @Override
                    ...
                    Toast.makeText(FlowSaferWillDetailActivity.this, "审批人为空", Toast.LENGTH_SHORT).show();
                }
                break;
            case R.id.tvData:
            ...
            case R.id.btnUp:
                Gson gson = new Gson();
                FlowSaferWillDetail bean = gson.fromJson(res, FlowSaferWillDetail.class);
                bmfzryj = bean.getMainform().get(0).getBmfzryj();
                fgldyj = bean.getMainform().get(0).getFgldyj();
                cwldyj = bean.getMainform().get(0).getCwzjyj();
                ...
                if (etLeader2.getVisibility() == View.VISIBLE) {
                    ...
                    jsonArray.put(jsonObject);
                    if (cwldyj.equals("")) {
                        cwldyj = jsonArray.toString();
                    } else {
                        cwldyj = cwldyj + "," + jsonArray.toString();
                        cwldyj = cwldyj.toString().replace("],[", ",");
                    }
                }
                if (comment.equals("")) {
    ...
    private void sendData() {
        ProgressDialogUtil.startLoad(FlowSaferWillDetailActivity.this, "提交数据中");
        new Thread(new Runnable() {
            @Override
            public void run() {
                final String liuShuiHao = tvLSH.getText().toString();
                ...
                final String userCode = new SharedPreferencesHelper(FlowSaferWillDetailActivity.this,
                        "login").getData(FlowSaferWillDetailActivity.this, "userCode", "");
                if (codetemp != null) {
                ...
                if (bigResultList.size() == 0 && bigResultList1.size() != 0) {
                    Looper.prepare();
                    ProgressDialogUtil.stopLoad();
                    Toast.makeText(FlowSaferWillDetailActivity.this, "请选择审批人", Toast.LENGTH_SHORT).show();
                    Looper.loop();
                } else {
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 333:
                    ProgressDialogUtil.stopLoad();
                    Toast.makeText(FlowSaferWillDetailActivity.this, getResources().getString(R.string.c_success), Toast.LENGTH_SHORT).show();
                    finish();
                    break;
                case 444:
                    ProgressDialogUtil.stopLoad();
                    Toast.makeText(FlowSaferWillDetailActivity.this, getResources().getString(R.string.c_false), Toast.LENGTH_SHORT).show();
                    break;
                case 111:
                    Gson gsonF = new Gson();
                    ...
                    adapter = new FlowMessageAdapter(FlowSaferWillDetailActivity.this, flowList);
                ...
                case TAG_ONE:
                    ...
                    final String liuShuiHao = bean.getMainform().get(0).getLiuShuiHao();
                    final String time = bean.getMainform().get(0).getJieKuanShiJian();
                    final String num = bean.getMainform().get(0).getTuanTiYiWaiXianRenShu();
                    ...
                    if (cwldyj != null && !cwldyj.equals("")) {
                        try {
                            JSONArray jsonArray = new JSONArray(cwldyj);
                    ...
                    break;
                case TAG_TWO:
                    Toast.makeText(FlowSaferWillDetailActivity.this, "操作数据失败", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_THERE:
                    Toast.makeText(FlowSaferWillDetailActivity.this, "提交数据成功", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    finish();
                    break;
                case TAG_FOUR:
                ...
                case TAG_SEVEN:
                    ...
                    break;
                case TAG_EIGHT:
                    Toast.makeText(FlowSaferWillDetailActivity.this, "流程已到最后一步，请提交", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_NINE:
                    Gson gson2 = new Gson();
