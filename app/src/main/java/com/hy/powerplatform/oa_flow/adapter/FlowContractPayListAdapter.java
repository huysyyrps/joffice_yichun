...
public class FlowContractPayListAdapter extends RecyclerView.Adapter<FlowContractPayListAdapter.ViewHolder> {
    ...
    Context context;
    public FlowContractPayListAdapter(FragmentActivity activity, List<MyLeave.ResultBean> beanList) {
