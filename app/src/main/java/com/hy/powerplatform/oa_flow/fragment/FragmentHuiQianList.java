...
import com.hy.powerplatform.oa_flow.activity.FlowHuiQianDetailActivity;
...
public class FragmentHuiQianList extends Fragment implements FlowContractPayListAdapter.OnGetAdapterPositionListener,Runnable {
    ...
    public void run() {
        String url = Constant.BASE_URL2 + Constant.MYLIST+start+"&limit="+limit+
                "&Q_subject_S_LK="+Constant.HUIQIANNAME;
    ...
    public void getAdapterPosition(int position) {
        ...
        Intent intent = new Intent(getActivity(), FlowHuiQianDetailActivity.class);
