...
import com.hy.powerplatform.oa_flow.activity.FlowOverTimeDetailActivity;
...
public class FragmentOverTimeList extends Fragment implements FlowContractPayListAdapter.OnGetAdapterPositionListener {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                url = Constant.BASE_URL2 + Constant.MYLIST + start + "&limit=" + limit
                        + "&Q_subject_S_LK=" + Constant.OVERTINENAME;
    ...
    public void getAdapterPosition(int position) {
        ...
        Intent intent = new Intent(getActivity(), FlowOverTimeDetailActivity.class);
