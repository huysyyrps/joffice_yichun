...
import com.hy.powerplatform.oa_flow.activity.FlowGHContractSignDetailActivity;
...
public class FragmentGHContractSignList extends Fragment implements FlowContractPayListAdapter.OnGetAdapterPositionListener,Runnable {
    ...
    @Override
    public void run() {
        String url = Constant.BASE_URL2 + Constant.MYLIST+start+"&limit="+limit+"&Q_subject_S_LK="+Constant.GHCONTRACTSIGNNAME;
    ...
    public void getAdapterPosition(int position) {
        ...
        Intent intent = new Intent(getActivity(), FlowGHContractSignDetailActivity.class);
