...
public class MyOverOpenDetailActivity extends BaseActivity {
    ...
    List<MyOverOpenList.ResultBean.AttachFilesBean> fileList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyOverOpenList.ResultBean bean = (MyOverOpenList.ResultBean) getIntent().getSerializableExtra("bean");
