...
import com.hy.powerplatform.oa_flow.fragment.FragmentDormData;
import com.hy.powerplatform.oa_flow.fragment.FragmentDormList;
 ...
 * 用车流程
 */
public class FlowDormActivity extends BaseActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        header.setTvTitle("员工宿舍申请表");
        fragment01 = new FragmentDormData();
        fragment02 = new FragmentDormList();
