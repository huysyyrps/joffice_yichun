...
import com.hy.powerplatform.oa_flow.bean.FlowCarSafeWillDetail;
    ...
    protected void rightClient() {
        ...
        tv_yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (str.equals("")) {
                    Toast.makeText(FlowCarSafeWillDetailActivity.this, getResources().getString(R.string.nullify_reason), Toast.LENGTH_SHORT).show();
                } else {
                    dialog.dismiss();
                    ProgressDialogUtil.startLoad(FlowCarSafeWillDetailActivity.this, getResources().getString(R.string.get_data));
...
//                res = dbA.OAQingJiaWillDoDex(url);
    ...
    public void getAppRovePerson() {
        ProgressDialogUtil.startLoad(FlowCarSafeWillDetailActivity.this, "获取数据中");
        new Thread(new Runnable() {
            @Override
            public void run() {
                DBHandler dbA = new DBHandler();
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnT:
                ...
                if (beanList.size() != 0) {
                    if (beanList.size() == 1) {
                        ...
                        MyAlertDialog.MyListAlertDialog(FlowCarSafeWillDetailActivity.this, namelist, new AlertDialogCallBackP() {
                            @Override
                    ...
                    Toast.makeText(FlowCarSafeWillDetailActivity.this, "审批人为空", Toast.LENGTH_SHORT).show();
                }
                break;
            case R.id.tvData:
            ...
            case R.id.btnUp:
                Gson gson = new Gson();
                FlowCarSafeWillDetail bean = gson.fromJson(res, FlowCarSafeWillDetail.class);
                bmfzryj = bean.getMainform().get(0).getBmfzryj();
                fgldyj = bean.getMainform().get(0).getFgldyj();
                zjl = bean.getMainform().get(0).getZjlyj();
                userName = new SharedPreferencesHelper(FlowCarSafeWillDetailActivity.this,
                        "login").getData(FlowCarSafeWillDetailActivity.this, "userStatus", "");
                userCode = new SharedPreferencesHelper(FlowCarSafeWillDetailActivity.this,
                        "login").getData(FlowCarSafeWillDetailActivity.this, "userId", "");
    ...
    private void sendData() {
        ProgressDialogUtil.startLoad(FlowCarSafeWillDetailActivity.this, "提交数据中");
        new Thread(new Runnable() {
            @Override
            public void run() {
                ...
                final String carNo1 = tvOutCarNo1.getText().toString() + "";
                final String carNo2 = tvOutCarNo2.getText().toString() + "";
                final String carNo3 = tvOutCarNo3.getText().toString() + "";
                final String carNo4 = tvOutCarNo4.getText().toString() + "";
                final String carNo5 = tvOutCarNo5.getText().toString() + "";

                final String comp1 = tvSafeSepart1.getText().toString() + "";
                final String comp2 = tvSafeSepart2.getText().toString() + "";
                final String comp3 = tvSafeSepart3.getText().toString() + "";
                final String comp4 = tvSafeSepart4.getText().toString() + "";
                final String comp5 = tvSafeSepart5.getText().toString() + "";

                final String type1 = tvSafeType1.getText().toString() + "";
                final String type2 = tvSafeType2.getText().toString() + "";
                final String type3 = tvSafeType3.getText().toString() + "";
                final String type4 = tvSafeType4.getText().toString() + "";
                final String type5 = tvSafeType5.getText().toString() + "";

                final String money1 = tvSafeMoney1.getText().toString() + "";
                final String money2 = tvSafeMoney2.getText().toString() + "";
                final String money3 = tvSafeMoney3.getText().toString() + "";
                final String money4 = tvSafeMoney4.getText().toString() + "";
                final String money5 = tvSafeMoney5.getText().toString() + "";
                ...
                final String userCode = new SharedPreferencesHelper(FlowCarSafeWillDetailActivity.this,
                        "login").getData(FlowCarSafeWillDetailActivity.this, "userCode", "");
                ...
                if (bigResultList.size() == 0 && bigResultList1.size() != 0) {
                    Looper.prepare();
                    ProgressDialogUtil.stopLoad();
                    Toast.makeText(FlowCarSafeWillDetailActivity.this, "请选择审批人", Toast.LENGTH_SHORT).show();
                    Looper.loop();
                } else {
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 333:
                    ProgressDialogUtil.stopLoad();
                    Toast.makeText(FlowCarSafeWillDetailActivity.this, getResources().getString(R.string.c_success), Toast.LENGTH_SHORT).show();
                    finish();
                    break;
                case 444:
                    ProgressDialogUtil.stopLoad();
                    Toast.makeText(FlowCarSafeWillDetailActivity.this, getResources().getString(R.string.c_false), Toast.LENGTH_SHORT).show();
                    break;
                case 111:
                    Gson gsonF = new Gson();
                    ...
                    adapter = new FlowMessageAdapter(FlowCarSafeWillDetailActivity.this, flowList);
                ...
                case TAG_ONE:
                    ...
                    break;
                case TAG_TWO:
                    Toast.makeText(FlowCarSafeWillDetailActivity.this, "操作失败", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_THERE:
                    Toast.makeText(FlowCarSafeWillDetailActivity.this, "提交数据成功", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    finish();
                    break;
                case TAG_FOUR:
                ...
                case TAG_SEVEN:
                    ...
                    break;
                case TAG_EIGHT:
                    Toast.makeText(FlowCarSafeWillDetailActivity.this, "流程已到最后一步，请提交", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_NINE:
                    Gson gson2 = new Gson();
