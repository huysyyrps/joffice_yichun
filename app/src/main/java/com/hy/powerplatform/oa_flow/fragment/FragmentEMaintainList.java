...
import com.hy.powerplatform.oa_flow.activity.FlowEMaintainDetailActivity;
...
public class FragmentEMaintainList extends Fragment implements FlowContractPayListAdapter.OnGetAdapterPositionListener,Runnable {
    ...
    public void run() {
        String url = Constant.BASE_URL2 + Constant.MYLIST+start+"&limit="+limit+
                "&Q_subject_S_LK="+Constant.EMAINTAINNAME;
    ...
    public void getAdapterPosition(int position) {
        ...
        Intent intent = new Intent(getActivity(), FlowEMaintainDetailActivity.class);
