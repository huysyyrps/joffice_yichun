...
import com.hy.powerplatform.oa_flow.bean.FlowCompMessageWill;
...
public class FlowCompMessageWillDetailActivity extends BaseActivity {
    ...
    List<FlowCompMessageWill.TransBean> beanList = new ArrayList<>();
...
//                res = dbA.OAQingJiaWillDoDex(url);
    ...
    protected int provideContentViewId() {
        return R.layout.activity_compmessage_data;
    }
    ...
    protected void rightClient() {
        ...
        tv_yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (str.equals("")) {
                    Toast.makeText(FlowCompMessageWillDetailActivity.this, getResources().getString(R.string.nullify_reason), Toast.LENGTH_SHORT).show();
                } else {
                    dialog.dismiss();
                    ProgressDialogUtil.startLoad(FlowCompMessageWillDetailActivity.this, getResources().getString(R.string.get_data));
                    new Thread(new Runnable() {
                        @Override
                        public void run() {
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnHistory:
                ...
                ProgressDialogUtil.startLoad(FlowCompMessageWillDetailActivity.this, "获取数据中");
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        //String name =URLDecoder.decode(待转值,"utf-8");
            ...
            case R.id.btnT:
                ...
                if (beanList.size() != 0) {
                    if (beanList.size() == 1) {
                        ...
                        MyAlertDialog.MyListAlertDialog(FlowCompMessageWillDetailActivity.this, namelist, new AlertDialogCallBackP() {
                            @Override
                    ...
                    Toast.makeText(FlowCompMessageWillDetailActivity.this, "审批人为空", Toast.LENGTH_SHORT).show();
                }
                break;
            case R.id.tvData:
            ...
            case R.id.btnUp:
                ...
                jsbmldyj = bean.getMainform().get(0).getJbbmyj();
                ...
                } else if (etLeader3.getVisibility() == View.VISIBLE) {
    ...
    private void sendData() {
        ProgressDialogUtil.startLoad(FlowCompMessageWillDetailActivity.this, "提交数据中");
        new Thread(new Runnable() {
            @Override
            public void run() {
                ...
                if (bigResultList.size() == 0 && bigResultList1.size() != 0) {
                    Looper.prepare();
                    ProgressDialogUtil.stopLoad();
                    Toast.makeText(FlowCompMessageWillDetailActivity.this, "请选择审批人", Toast.LENGTH_SHORT).show();
                    Looper.loop();
                } else {
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 333:
                    ProgressDialogUtil.stopLoad();
                    Toast.makeText(FlowCompMessageWillDetailActivity.this, getResources().getString(R.string.c_success), Toast.LENGTH_SHORT).show();
                    finish();
                    break;
                case 444:
                    ProgressDialogUtil.stopLoad();
                    Toast.makeText(FlowCompMessageWillDetailActivity.this, getResources().getString(R.string.c_false), Toast.LENGTH_SHORT).show();
                    break;
                case 111:
                    Gson gsonF = new Gson();
                    ...
                    adapter = new FlowMessageAdapter(FlowCompMessageWillDetailActivity.this, flowList);
                ...
                case TAG_ONE:
                    ...
                    final String date = bean.getMainform().get(0).getRq();
                    final String person = bean.getMainform().get(0).getNg();
                    final String title = bean.getMainform().get(0).getBt();
                    fbpt1 = bean.getMainform().get(0).getFbpt1();
                    fbpt2 = bean.getMainform().get(0).getFbpt2();
                    fbpt3 = bean.getMainform().get(0).getFbpt3();
                    ...
                    try {
                        ...
                        jsreout = jsonObject.getString("zhglbyj");
                        jsldreout = jsonObject.getString("jbbmyj");
                    ...
                    if (bean.isRevoke()) {
                        Toast.makeText(FlowCompMessageWillDetailActivity.this, "当前流程已被追回", Toast.LENGTH_SHORT).show();
                    }
                    ProgressDialogUtil.stopLoad();
                    if (beanList.size() == 1) {
                        btnT.setVisibility(View.GONE);
                        tvText.setVisibility(View.GONE);
                        ProgressDialogUtil.startLoad(FlowCompMessageWillDetailActivity.this, "获取审核人");
                        getAppRovePerson();
                    } else {
                    ...
                    break;
                case TAG_TWO:
                    Toast.makeText(FlowCompMessageWillDetailActivity.this, "操作失败", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_THERE:
                    Toast.makeText(FlowCompMessageWillDetailActivity.this, "提交数据成功", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    finish();
                    break;
                case TAG_FOUR:
                ...
                case TAG_SEVEN:
                    ...
                    if (bean1.getData() != null) {
                        if (bean1.getData().size() > 1) {
                            ...
                            if (bean1.getData().get(0).getRole().equals("办结安排") || bean1.getData().get(0).getRole().equals("承办部门")) {
                    ...
                    break;
                case TAG_EIGHT:
                    Toast.makeText(FlowCompMessageWillDetailActivity.this, "流程已到最后一步，请提交", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_NINE:
                    Gson gson2 = new Gson();
