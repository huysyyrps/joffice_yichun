...
public class OverOpenDetailActivity extends BaseActivity {
    ...
    List<OverOpenList.ResultBean.AttachFilesBean> fileList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        OverOpenList.ResultBean bean = (OverOpenList.ResultBean) getIntent().getSerializableExtra("bean");
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case TAG_TWO:
                    Toast.makeText(OverOpenDetailActivity.this, "操作数据失败", Toast.LENGTH_SHORT).show();
