...
import com.hy.powerplatform.oa_flow.fragment.FragmentCarData;
import com.hy.powerplatform.oa_flow.fragment.FragmentCarList;
 ...
 * 用车流程
 */
public class FlowCarActivity extends BaseActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        header.setTvTitle("用车申请单");
        fragment01 = new FragmentCarData();
        fragment02 = new FragmentCarList();
