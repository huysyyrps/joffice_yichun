...
public class FlowGHPayWillDetailActivity extends BaseActivity {
    ...
    private String name, taskId, res, fullnameUId, fullname, bmfzr, fgcwze, zjl = "";
    ...
    String bmreout, fgcwreout, zjlreout, flowAssignld, serialNumber = "";
    ...
    List<FlowGHPayWillDetail.TransBean> beanList = new ArrayList<>();
    ...
    protected int provideContentViewId() {
        return R.layout.activity_ghpaywill;
    }
    ...
    protected void rightClient() {
        ...
        tv_yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (str.equals("")) {
                    Toast.makeText(FlowGHPayWillDetailActivity.this, getResources().getString(R.string.nullify_reason), Toast.LENGTH_SHORT).show();
                } else {
                    dialog.dismiss();
                    ProgressDialogUtil.startLoad(FlowGHPayWillDetailActivity.this, getResources().getString(R.string.get_data));
...
//                res = dbA.OAQingJiaWillDoDex(url);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnHistory:
                ...
                ProgressDialogUtil.startLoad(FlowGHPayWillDetailActivity.this, "获取数据中");
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        //String name =URLDecoder.decode(待转值,"utf-8");
            ...
            case R.id.btnT:
                ...
                if (beanList.size() != 0) {
                    if (beanList.size() == 1) {
                        ...
                        MyAlertDialog.MyListAlertDialog(FlowGHPayWillDetailActivity.this, namelist, new AlertDialogCallBackP() {
                            @Override
                    ...
                    Toast.makeText(FlowGHPayWillDetailActivity.this, "审批人为空", Toast.LENGTH_SHORT).show();
                }
                break;
            case R.id.tvData:
    ...
    private void sendData() {
        ProgressDialogUtil.startLoad(FlowGHPayWillDetailActivity.this, "提交数据中");
        new Thread(new Runnable() {
            @Override
            public void run() {
                ...
                final String userCode = new SharedPreferencesHelper(FlowGHPayWillDetailActivity.this,
                        "login").getData(FlowGHPayWillDetailActivity.this, "userCode", "");
                if (codetemp != null) {
                ...
                if (bigResultList.size() == 0 && bigResultList1.size() != 0) {
                    Looper.prepare();
                    ProgressDialogUtil.stopLoad();
                    Toast.makeText(FlowGHPayWillDetailActivity.this, "请选择审批人", Toast.LENGTH_SHORT).show();
                    Looper.loop();
                } else {
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 333:
                    ProgressDialogUtil.stopLoad();
                    Toast.makeText(FlowGHPayWillDetailActivity.this, getResources().getString(R.string.c_success), Toast.LENGTH_SHORT).show();
                    finish();
                    break;
                case 444:
                    ProgressDialogUtil.stopLoad();
                    Toast.makeText(FlowGHPayWillDetailActivity.this, getResources().getString(R.string.c_false), Toast.LENGTH_SHORT).show();
                    break;
                case 111:
                    Gson gsonF = new Gson();
                    ...
                    adapter = new FlowMessageAdapter(FlowGHPayWillDetailActivity.this, flowList);
                ...
                case TAG_ONE:
                    ...
                    try {
                        ...
                        if (bmreout.equals("1") && fgcwreout.equals("1") && zjlreout.equals("1")) {
                            Toast.makeText(FlowGHPayWillDetailActivity.this, "您对当前流程只有读取权限", Toast.LENGTH_SHORT).show();
                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                    ...
                    if (bean.isRevoke()) {
                        Toast.makeText(FlowGHPayWillDetailActivity.this, "当前流程已被追回", Toast.LENGTH_SHORT).show();
                    }
                    ProgressDialogUtil.stopLoad();
                    if (beanList.size() == 1) {
                        btnT.setVisibility(View.GONE);
                        tvText.setVisibility(View.GONE);
                        ProgressDialogUtil.startLoad(FlowGHPayWillDetailActivity.this, "获取审核人");
                        getAppRovePerson();
                    }
                    break;
                case TAG_TWO:
                    Toast.makeText(FlowGHPayWillDetailActivity.this, "操作数据失败", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_THERE:
                    Toast.makeText(FlowGHPayWillDetailActivity.this, "提交数据成功", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    finish();
                    break;
                case TAG_FOUR:
                ...
                case TAG_SEVEN:
                    ...
                    break;
                case TAG_EIGHT:
                    Toast.makeText(FlowGHPayWillDetailActivity.this, "流程已到最后一步，请提交", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_NINE:
                    Gson gson2 = new Gson();
