...
public class FlowEMaintainDetailActivity extends BaseActivity {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 111:
                    ...
                    Toast.makeText(FlowEMaintainDetailActivity.this, "查询成功", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_ONE:
                    Gson gson = new Gson();
                    FlowEMaintainDetail bean = gson.fromJson(res, FlowEMaintainDetail.class);
                    ...
                    final String bxbm = bean.getMainform().get(0).getBmfzryj();
                    final String wxbm = bean.getMainform().get(0).getXxjsbyj();
                    final String wxry = bean.getMainform().get(0).getWeiXiuRenYuanQianZi();
                    final String wxql = bean.getMainform().get(0).getBjap();
                    final String sbsyr = bean.getMainform().get(0).getSheBeiShiYongRenQianZi();
                    ...
                    break;
                case TAG_TWO:
                    Toast.makeText(FlowEMaintainDetailActivity.this, "获取数据失败，请重试", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_NINE:
                    Gson gson1 = new Gson();
                    ...
                    break;
                case TAG_FIVE:
                    Toast.makeText(FlowEMaintainDetailActivity.this, msg.getData().getString("msg"), Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    finish();
                    break;
                case TAG_SIX:
                    Toast.makeText(FlowEMaintainDetailActivity.this, "提交数据失败", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
            }
        }
