...
import com.hy.powerplatform.oa_flow.bean.FlowGHContractSignDetail;
...
public class FlowGHContractSignDetailActivity extends BaseActivity {
    ...
    protected int provideContentViewId() {
        return R.layout.activity_ghcontractsign_detail;
    }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 111:
                    ...
                    Toast.makeText(FlowGHContractSignDetailActivity.this, "查询成功", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_ONE:
                    Gson gson = new Gson();
                    FlowGHContractSignDetail bean = gson.fromJson(res, FlowGHContractSignDetail.class);
                    ...
                    String csbmyj = bean.getMainform().get(0).getBmfzryj();
                    String jgbmyj = bean.getMainform().get(0).getCwsjbyj();
                    String flgwyj = bean.getMainform().get(0).getJcbmyj();
                    ...
                    break;
                case TAG_TWO:
                    Toast.makeText(FlowGHContractSignDetailActivity.this, "获取数据失败，请重试", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_NINE:
                    Gson gson2 = new Gson();
                    ...
                    break;
                case TAG_FIVE:
                    Toast.makeText(FlowGHContractSignDetailActivity.this, msg.getData().getString("msg"), Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    finish();
                    break;
                case TAG_SIX:
                    Toast.makeText(FlowGHContractSignDetailActivity.this, "提交数据失败", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
            }
        }
