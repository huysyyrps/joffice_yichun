...
import com.hy.powerplatform.oa_flow.activity.FlowDriverAssessWillDetailActivity;
...
public class FragmentDriverAssessWillDo extends Fragment implements FlowQingJiaWillDoAdapter.OnGetAdapterPositionListener {
...
//        recyclerView.setLoadMoreEnable(false);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                String url = Constant.BASE_URL2 + Constant.WILLDOLIST + start + "&limit="
                        + limit+"&Q_subject_S_LK="+Constant.DRIVERASSESSNAME;
    ...
    public void getAdapterPosition(int position) {
        Intent intent = new Intent(getActivity(), FlowDriverAssessWillDetailActivity.class);
