...
import com.hy.powerplatform.oa_flow.bean.FlowJSGCDetail;
...
public class FlowJSGCDetailActivity extends BaseActivity {
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.btnHistory:
                ...
                ProgressDialogUtil.startLoad(FlowJSGCDetailActivity.this, "获取数据中");
                new Thread(new Runnable() {
                    @Override
                    public void run() {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case TAG_ONE:
                    Gson gson = new Gson();
                    FlowJSGCDetail bean = gson.fromJson(res, FlowJSGCDetail.class);
                    ...
                    final String xqbm = bean.getMainform().get(0).getBmfzryj();
                    final String xqbmldyj = bean.getMainform().get(0).getFgldyj();
                    final String jsbmyj = bean.getMainform().get(0).getJjbzbyj();
                    final String jsfgldyj = bean.getMainform().get(0).getJbfgldyj();
                    String zjlyj = bean.getMainform().get(0).getZjlyj();
                    String data = bean.getMainform().get(0).getXuQiuShiXiang();
                    ...
                    break;
                case TAG_TWO:
                    Toast.makeText(FlowJSGCDetailActivity.this, "获取数据失败，请重试", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_NINE:
                    Gson gson2 = new Gson();
                    ...
                    break;
                case TAG_FIVE:
                    Toast.makeText(FlowJSGCDetailActivity.this, msg.getData().getString("msg"), Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    finish();
                    break;
                case TAG_SIX:
                    Toast.makeText(FlowJSGCDetailActivity.this, "提交数据失败", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
            }
        }
