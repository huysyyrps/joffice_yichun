...
import com.hy.powerplatform.oa_flow.bean.MyFuKuanLiuChengDetail;
...
public class FlowFuKuanLiuChengDetailActivity extends BaseActivity {
    ...
    protected int provideContentViewId() {
        return R.layout.activity_shenpiliucheng_detail;
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.btnHistory:
                ...
                ProgressDialogUtil.startLoad(FlowFuKuanLiuChengDetailActivity.this, "获取数据中");
                new Thread(new Runnable() {
                    @Override
                    public void run() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 111:
                    ...
                    adapter = new FlowMessageAdapter(FlowFuKuanLiuChengDetailActivity.this, flowList);
                    recyclerView.setAdapter(adapter);
                    Toast.makeText(FlowFuKuanLiuChengDetailActivity.this, "查询成功", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_ONE:
                    Gson gson = new Gson();
                    MyFuKuanLiuChengDetail bean = gson.fromJson(res, MyFuKuanLiuChengDetail.class);
                    ...
                    break;
                case TAG_TWO:
                    Toast.makeText(FlowFuKuanLiuChengDetailActivity.this, "获取数据失败，请重试", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_NINE:
                    Gson gson2 = new Gson();
                    ...
                    break;
                case TAG_FIVE:
                    Toast.makeText(FlowFuKuanLiuChengDetailActivity.this, msg.getData().getString("msg"), Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    finish();
                    break;
                case TAG_SIX:
                    Toast.makeText(FlowFuKuanLiuChengDetailActivity.this, "提交数据失败", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
            }
        }
