...
import com.hy.powerplatform.oa_flow.activity.FlowContractSignDetailActivity;
...
public class FragmentContractSignList extends Fragment implements FlowContractPayListAdapter.OnGetAdapterPositionListener,Runnable {
    ...
    @Override
    public void run() {
        String url = Constant.BASE_URL2 + Constant.MYLIST+start+"&limit="+limit+"&Q_subject_S_LK="+Constant.CONTRACTSIGNNAME;
    ...
    public void getAdapterPosition(int position) {
        ...
        Intent intent = new Intent(getActivity(), FlowContractSignDetailActivity.class);
