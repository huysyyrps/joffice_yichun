...
import com.hy.powerplatform.oa_flow.bean.FlowHuiQianDetail;
...
public class FlowHuiQianDetailActivity extends BaseActivity {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case TAG_ONE:
                    Gson gson = new Gson();
                    FlowHuiQianDetail bean = gson.fromJson(res, FlowHuiQianDetail.class);
                    final String data = bean.getMainform().get(0).getHuiQianShiXiang();
                    final String person = bean.getMainform().get(0).getSqr();
                    final String bxbm = bean.getMainform().get(0).getJbfgldyj();
                    ...
                    if (!wxry.equals("")) {
                        tvLeader2.setText(getJSONData(wxry));
                    }else {
                    ...
                    break;
                case TAG_TWO:
                    Toast.makeText(FlowHuiQianDetailActivity.this, "获取数据失败，请重试", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_NINE:
                    Gson gson1 = new Gson();
                    ...
                    break;
                case TAG_FIVE:
                    Toast.makeText(FlowHuiQianDetailActivity.this, msg.getData().getString("msg"), Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    finish();
                    break;
                case TAG_SIX:
                    Toast.makeText(FlowHuiQianDetailActivity.this, "提交数据失败", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
            }
        }
