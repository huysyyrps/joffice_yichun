...
import com.hy.powerplatform.oa_flow.activity.FlowGCAddDetailActivity;
...
public class FragmentGcList extends Fragment implements FlowContractPayListAdapter.OnGetAdapterPositionListener,Runnable {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        getData(start, limit);
        setClient();
        //Toast.makeText(getContext(), ((FlowNewGCActivity)getActivity()).getTag(), Toast.LENGTH_SHORT).show();
    }
...
//                        +"&subject="+Constant.GCADDNAME;
    ...
    public void getAdapterPosition(int position) {
        ...
        Intent intent = new Intent(getActivity(), FlowGCAddDetailActivity.class);
