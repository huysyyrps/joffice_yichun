...
import com.hy.powerplatform.oa_flow.bean.FlowRepair;
...
public class FlowRepairWillDetailActivity extends BaseActivity {
    ...
    String tag = "noEnd";
    String comment = "";
    String fgreout, zjlreout, flowAssignld, serialNumber, yj = "";

    String etLeaderW1 = "", etLeaderW2 = "", etLeaderW3 = "", etLeaderW4 = "", etLeaderW5 = "";
    String etRout1 = "", etRout2 = "", etRout3 = "", etRout4 = "", etRout5 = "";
    ...
    protected void rightClient() {
        ...
        tv_yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (str.equals("")) {
                    Toast.makeText(FlowRepairWillDetailActivity.this, getResources().getString(R.string.nullify_reason), Toast.LENGTH_SHORT).show();
                } else {
                    dialog.dismiss();
                    ProgressDialogUtil.startLoad(FlowRepairWillDetailActivity.this, getResources().getString(R.string.get_data));
...
//                res = dbA.OAQingJiaWillDoDex(url);
    ...
    @OnClick({R.id.btnUp, R.id.tvDerper, R.id.btnT, R.id.btnHistory, R.id.llShenPiRen})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnHistory:
                ...
                ProgressDialogUtil.startLoad(FlowRepairWillDetailActivity.this, "获取数据中");
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        //String name =URLDecoder.decode(待转值,"utf-8");
            ...
            case R.id.btnT:
                ...
                if (beanList.size() != 0) {
                    if (beanList.size() == 1) {
                        ...
                        MyAlertDialog.MyListAlertDialog(FlowRepairWillDetailActivity.this, namelist, new AlertDialogCallBackP() {
                            @Override
                    ...
                    Toast.makeText(FlowRepairWillDetailActivity.this, "审批人为空", Toast.LENGTH_SHORT).show();
                }
                break;
            case R.id.tvDerper:
            ...
            case R.id.btnUp:
                Gson gson = new Gson();
                FlowRepair bean = gson.fromJson(res, FlowRepair.class);
                ...
                etLeaderW5 = bean.getMainform().get(0).getWeiXiuQingKuangFanKui();
                userName = new SharedPreferencesHelper(FlowRepairWillDetailActivity.this,
                        "login").getData(FlowRepairWillDetailActivity.this, "userStatus", "");
                userCode = new SharedPreferencesHelper(FlowRepairWillDetailActivity.this,
                        "login").getData(FlowRepairWillDetailActivity.this, "userId", "");
                ...
                if (etLeader.getVisibility() == View.VISIBLE) {
                    ...
                    if (etLeaderW1.equals("")) {
                        etLeaderW1 = jsonArray.toString();
                    } else {
                        etLeaderW1 = etLeaderW1 + "," + jsonArray.toString();
                        etLeaderW1 = etLeaderW1.toString().replace("],[", ",");
                    }
                }
                if (etLeader1.getVisibility() == View.VISIBLE) {
                    ...
                    if (etLeaderW2.equals("")) {
                        etLeaderW2 = jsonArray.toString();
                    } else {
                        etLeaderW2 = etLeaderW2 + "," + jsonArray.toString();
                        etLeaderW2 = etLeaderW2.toString().replace("],[", ",");
                    }
                }
                if (etLeader2.getVisibility() == View.VISIBLE) {
                    comment = etLeader2.getText().toString();
                    etLeaderW3 = etLeader2.getText().toString();
//            try {
//                jsonObject.put("ui", userCode);
//                jsonObject.put("un", userName);
//                jsonObject.put("c", str);
...
//            }
//            jsonArray.put(jsonObject);
//            if (etLeaderW3.equals("")) {
//                etLeaderW3 = jsonArray.toString();
//            } else {
//                etLeaderW3 = etLeaderW3 + "," + jsonArray.toString();
//                etLeaderW3 = etLeaderW3.toString().replace("],[", ",");
//            }
                }
                if (etLeader3.getVisibility() == View.VISIBLE) {
                    ...
                    if (etLeaderW4.equals("")) {
                        etLeaderW4 = jsonArray.toString();
                    } else {
                        etLeaderW4 = etLeaderW4 + "," + jsonArray.toString();
                        etLeaderW4 = etLeaderW4.toString().replace("],[", ",");
                    }
                }
                if (etYJ.getVisibility() == View.VISIBLE) {
                    comment = etYJ.getText().toString();
                    try {
                        jsonObject.put("ui", userCode);
                        jsonObject.put("un", userName);
                        jsonObject.put("c", str);
                        jsonObject.put("v", etYJ.getText().toString());
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                    jsonArray.put(jsonObject);
                    if (etLeaderW5.equals("")) {
                        etLeaderW5 = jsonArray.toString();
                    } else {
                        etLeaderW5 = etLeaderW5 + "," + jsonArray.toString();
                        etLeaderW5 = etLeaderW5.toString().replace("],[", ",");
                    }
                }

                if (comment.equals("")) {
                    if (!("2").equals(etRout1) && !("2").equals(etRout2) && !("2").equals(etRout3) && !("2").
                            equals(etRout4) && !("2").equals(etRout5)) {
                        comment = "";
                        personSession();
                    } else if (!etLeaderW1.equals("") && !etLeaderW2.equals("") && !etLeaderW3.equals("")
                            && !etLeaderW4.equals("") && !etLeaderW5.equals("")) {
                        comment = "";
                        personSession();
                    } else {
    ...
    private void sendData() {
        ProgressDialogUtil.startLoad(FlowRepairWillDetailActivity.this, "提交数据中");
        new Thread(new Runnable() {
            @Override
            public void run() {
                String departement = tvDepartment.getText().toString();
                String address = tvAddress.getText().toString();
                String date = tvDate.getText().toString();
                String data = tvData.getText().toString();
                String depPerson = tvDerper.getText().toString();
                final String userCode = new SharedPreferencesHelper(FlowRepairWillDetailActivity.this,
                        "login").getData(FlowRepairWillDetailActivity.this, "userCode", "");
                if (codetemp != null) {
                ...
                if (bigResultList.size() == 0 && bigResultList1.size() != 0) {
                    Looper.prepare();
                    ProgressDialogUtil.stopLoad();
                    Toast.makeText(FlowRepairWillDetailActivity.this, "请选择审批人", Toast.LENGTH_SHORT).show();
                    Looper.loop();
                } else {
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 333:
                    ProgressDialogUtil.stopLoad();
                    Toast.makeText(FlowRepairWillDetailActivity.this, getResources().getString(R.string.c_success), Toast.LENGTH_SHORT).show();
                    finish();
                    break;
                case 444:
                    ProgressDialogUtil.stopLoad();
                    Toast.makeText(FlowRepairWillDetailActivity.this, getResources().getString(R.string.c_false), Toast.LENGTH_SHORT).show();
                    break;
                case 111:
                    Gson gsonF = new Gson();
                    ...
                    adapter = new FlowMessageAdapter(FlowRepairWillDetailActivity.this, flowList);
...
//                    String yj = bean.getMainform().get(0).getWeiXiuQingKuangFanKuiYiJian();
//                    String depPerson = bean.getMainform().get(0).getBaoXiuBuMenRenYuanQianZi();
                        etLeaderW1 = bean.getMainform().get(0).getBmfzryj();
                        etLeaderW2 = bean.getMainform().get(0).getJjbzbyj();
                        etLeaderW3 = bean.getMainform().get(0).getWeiXiuRenYuanQianZi();
                        etLeaderW4 = bean.getMainform().get(0).getBjap();
                        ...
                        try {
                            ...
                            etRout1 = jsonObject.getString("bmfzryj");
                            etRout2 = jsonObject.getString("jjbzbyj");
                            etRout3 = jsonObject.getString("WeiXiuRenYuanQianZi");
                            etRout4 = jsonObject.getString("bjap");
                            etRout5 = jsonObject.getString("bjpj");
                            if (etRout1.equals("2")) {
...
//                            }
                        ...
                        ProgressDialogUtil.stopLoad();
                        Toast.makeText(FlowRepairWillDetailActivity.this, "获取数据失败，请重试", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                    break;
                case TAG_TWO:
                    Toast.makeText(FlowRepairWillDetailActivity.this, "操作数据失败", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_THERE:
                    Toast.makeText(FlowRepairWillDetailActivity.this, "提交数据成功", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    finish();
                    break;
                case TAG_FOUR:
                ...
                case TAG_SEVEN:
                    ...
                    break;
                case TAG_EIGHT:
                    Toast.makeText(FlowRepairWillDetailActivity.this, "流程已到最后一步，请提交", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_NINE:
                    Gson gson2 = new Gson();
