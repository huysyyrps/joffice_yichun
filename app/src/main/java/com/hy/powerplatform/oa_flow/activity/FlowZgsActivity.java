...
import com.hy.powerplatform.oa_flow.fragment.FragmentZgsData;
import com.hy.powerplatform.oa_flow.fragment.FragmentZgsList;
 ...
 * 用车流程
 */
public class FlowZgsActivity extends BaseActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        header.setTvTitle("子公司付款流程");
        fragment01 = new FragmentZgsData();
        fragment02 = new FragmentZgsList();
