...
import com.hy.powerplatform.oa_flow.activity.newgoodpurchase.fragment.FragmentNewGoodsPurchaseData;
import com.hy.powerplatform.oa_flow.activity.newgoodpurchase.fragment.FragmentNewGoodsPurchaseList;
...
public class FlowPurchaseNewActivity extends BaseActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        header.setTvTitle("物品采购(新)");
        fragment01 = new FragmentNewGoodsPurchaseData();
        fragment02 = new FragmentNewGoodsPurchaseList();
    ...
    protected int provideContentViewId() {
        return R.layout.activity_flow_purchase_new;
    }
