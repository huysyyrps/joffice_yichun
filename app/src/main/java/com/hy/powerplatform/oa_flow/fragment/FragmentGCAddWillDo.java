...
import com.hy.powerplatform.oa_flow.activity.FlowGCAddWillDetailActivity;
...
public class FragmentGCAddWillDo extends Fragment implements FlowQingJiaWillDoAdapter.OnGetAdapterPositionListener ,Runnable{
...
//        recyclerView.setLoadMoreEnable(false);
    ...
    public void run() {
        String url = "";
        if (tag.equals("1")){
            url = Constant.BASE_URL2 + Constant.WILLDOLIST+start+"&limit="+limit
                    +"&Q_subject_S_LK="+Constant.GCADDNAME;
        }else if (tag.equals("2")){
            url = Constant.BASE_URL2 + Constant.WILLDOLIST+start+"&limit="+limit
                    +"&Q_subject_S_LK="+Constant.GCCHECKNAME;
        }
//                url = Constant.BASE_URL2 + Constant.WILLDOLIST + start +
//                        "&limit=" + limit+"&subject="+Constant.GCADDNAME;
    ...
    public void getAdapterPosition(int position) {
        Intent intent = new Intent(getActivity(), FlowGCAddWillDetailActivity.class);
            ...
            switch (msg.what) {
                case TAG_ONE:
                    try {
                        ...
                        if (jsonObject.getString("totalCounts").equals("0")) {
