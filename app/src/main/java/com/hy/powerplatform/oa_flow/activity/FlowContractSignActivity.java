...
import com.hy.powerplatform.oa_flow.fragment.FragmentContractSignData;
import com.hy.powerplatform.oa_flow.fragment.FragmentContractSignList;
 ...
 * 合同付款审批
 */
public class FlowContractSignActivity extends BaseActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        header.setTvTitle("合同签订审批单");
        fragment01 = new FragmentContractSignData();
        fragment02 = new FragmentContractSignList();
    ...
    protected int provideContentViewId() {
        return R.layout.activity_flow_out_message;
    }
