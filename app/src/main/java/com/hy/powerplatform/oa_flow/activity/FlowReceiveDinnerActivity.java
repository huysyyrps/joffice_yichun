...
import com.hy.powerplatform.oa_flow.fragment.FragmentReceiveDinnerData;
import com.hy.powerplatform.oa_flow.fragment.FragmentReceiveDinnerList;
 ...
 * 接待用餐审批表
 */
public class FlowReceiveDinnerActivity extends BaseActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        header.setTvTitle("接待用餐审批单");
        fragment01 = new FragmentReceiveDinnerData();
        fragment02 = new FragmentReceiveDinnerList();
