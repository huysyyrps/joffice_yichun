...
public class MyWillOpenDetailActivity extends BaseActivity {
    ...
    List<MyWillOpenList.ResultBean.AttachFilesBean> fileList = new ArrayList<>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        ButterKnife.bind(this);
        MyWillOpenList.ResultBean bean = (MyWillOpenList.ResultBean) getIntent().getSerializableExtra("bean");
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case TAG_TWO:
                    Toast.makeText(MyWillOpenDetailActivity.this, "操作数据失败", Toast.LENGTH_SHORT).show();
