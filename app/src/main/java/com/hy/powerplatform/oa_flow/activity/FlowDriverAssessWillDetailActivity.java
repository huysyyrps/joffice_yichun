...
import com.hy.powerplatform.oa_flow.bean.FlowDriverAssessWillDetail;
...
public class FlowDriverAssessWillDetailActivity extends BaseActivity {
    ...
    List<FlowDriverAssessWillDetail.TransBean> beanList = new ArrayList<>();
    ...
    protected int provideContentViewId() {
        return R.layout.activity_driverassess_data;
    }
    ...
    protected void rightClient() {
        ...
        tv_yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (str.equals("")) {
                    Toast.makeText(FlowDriverAssessWillDetailActivity.this, getResources().getString(R.string.nullify_reason), Toast.LENGTH_SHORT).show();
                } else {
                    dialog.dismiss();
                    ProgressDialogUtil.startLoad(FlowDriverAssessWillDetailActivity.this, getResources().getString(R.string.get_data));
...
//                res = dbA.OAQingJiaWillDoDex(url);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnT:
                ...
                if (beanList.size() != 0) {
                    if (beanList.size() == 1) {
                        ...
                        MyAlertDialog.MyListAlertDialog(FlowDriverAssessWillDetailActivity.this, namelist, new AlertDialogCallBackP() {
                            @Override
                    ...
                    Toast.makeText(FlowDriverAssessWillDetailActivity.this, "审批人为空", Toast.LENGTH_SHORT).show();
                }
                break;
            case R.id.tvData:
            ...
            case R.id.btnUp:
                Gson gson = new Gson();
                FlowDriverAssessWillDetail bean = gson.fromJson(res, FlowDriverAssessWillDetail.class);
                bmfzryj = bean.getMainform().get(0).getBmfzryj();
                fgldyj = bean.getMainform().get(0).getJbbmyj();
                zjl = bean.getMainform().get(0).getRlzybyj();
                userName = new SharedPreferencesHelper(FlowDriverAssessWillDetailActivity.this,
                        "login").getData(FlowDriverAssessWillDetailActivity.this, "userStatus", "");
                userCode = new SharedPreferencesHelper(FlowDriverAssessWillDetailActivity.this,
                        "login").getData(FlowDriverAssessWillDetailActivity.this, "userId", "");
    ...
    private void sendData() {
        ProgressDialogUtil.startLoad(FlowDriverAssessWillDetailActivity.this, "提交数据中");
        new Thread(new Runnable() {
            @Override
            public void run() {
                final String person = tvPerson.getText().toString();
                final String userCode = new SharedPreferencesHelper(FlowDriverAssessWillDetailActivity.this,
                        "login").getData(FlowDriverAssessWillDetailActivity.this, "userCode", "");
                if (codetemp != null) {
            ...
            switch (msg.what) {
                ...
                case TAG_ONE:
                    ...
                    try {
                        ...
                        fgreout = jsonObject.getString("jbbmyj");
                        zjlreout = jsonObject.getString("rlzybyj");
                        if (bmreout.equals("2")) {
                ...
                case TAG_TWO:
                    ...
                    break;
                case TAG_THERE:
                    Toast.makeText(FlowDriverAssessWillDetailActivity.this, "提交数据成功", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    finish();
                    break;
                case TAG_FOUR:
                ...
                case TAG_SEVEN:
                    ...
                    break;
                case TAG_EIGHT:
                    Toast.makeText(FlowDriverAssessWillDetailActivity.this, "流程已到最后一步，请提交", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_NINE:
                    Gson gson2 = new Gson();
