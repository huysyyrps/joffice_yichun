...
import com.hy.powerplatform.oa_flow.bean.FlowComplainWillDetail;
...
public class FlowComplainWillDetailActivity extends BaseActivity {
    ...
    private String name, taskId, res, fullnameUId, fullname, bmfzr, fgsfze, yygs, aqfy, fkts = "";
    ...
    String comment = "";
    String comment1 = "";
    String bmreout, fgreout, yyreout, aqreout, fkreout, flowAssignld, serialNumber = "";
    ...
    List<FlowComplainWillDetail.TransBean> beanList = new ArrayList<>();
...
//                res = dbA.OAQingJiaWillDoDex(url);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnHistory:
                ...
                ProgressDialogUtil.startLoad(FlowComplainWillDetailActivity.this, "获取数据中");
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        //String name =URLDecoder.decode(待转值,"utf-8");
            ...
            case R.id.btnT:
                ...
                if (beanList.size() != 0) {
                    if (beanList.size() == 1) {
                        ...
                        MyAlertDialog.MyListAlertDialog(FlowComplainWillDetailActivity.this, namelist, new AlertDialogCallBackP() {
                            @Override
                    ...
                    Toast.makeText(FlowComplainWillDetailActivity.this, "审批人为空", Toast.LENGTH_SHORT).show();
                }
            ...
            case R.id.btnUp:
                Gson gson = new Gson();
                FlowComplainWillDetail bean = gson.fromJson(res, FlowComplainWillDetail.class);
                bmfzr = bean.getMainform().get(0).getBmfzryj();
                fgsfze = bean.getMainform().get(0).getFenGongSiChengBanRen();
                yygs = bean.getMainform().get(0).getBjap();
                aqfy = bean.getMainform().get(0).getAqfwbyj();
                fkts = bean.getMainform().get(0).getBjpj();
                ...
                if (etLeader1.getVisibility() == View.VISIBLE) {
                    comment1 = etLeader1.getText().toString();
                    JSONArray jsonArray = new JSONArray();
                    try {
                        jsonObject.put("ui", userCode);
                        jsonObject.put("un", userName);
                ...
                if (etLeader2.getVisibility() == View.VISIBLE) {
                    ...
                    jsonArray.put(jsonObject);
                    if (yygs.equals("")) {
                        yygs = jsonArray.toString();
                    } else {
                        yygs = yygs + "," + jsonArray.toString();
                        yygs = yygs.toString().replace("],[", ",");
                    }
                }
                if (etLeader3.getVisibility() == View.VISIBLE) {
                    ...
                    jsonArray.put(jsonObject);
                    if (aqfy.equals("")) {
                        aqfy = jsonArray.toString();
                    } else {
                        aqfy = aqfy + "," + jsonArray.toString();
                        aqfy = aqfy.toString().replace("],[", ",");
                    }
                }
                if (etLeader4.getVisibility() == View.VISIBLE) {
                    ...
                    jsonArray.put(jsonObject);
                    if (fkts.equals("")) {
                        fkts = jsonArray.toString();
                    } else {
                        fkts = fkts + "," + jsonArray.toString();
                        fkts = fkts.toString().replace("],[", ",");
                    }
                }
                if (comment.equals("")) {
                    if (!bmreout.equals("2") && !fgreout.equals("2") && !yyreout.equals("2")
                            && !aqreout.equals("2") && !fkreout.equals("2")) {
                        comment = "";
                        personSession();
                    } else if (!fkts.equals("") && !aqfy.equals("") && !yygs.equals("")
                            && !fgsfze.equals("") && !bmfzr.equals("")) {
                        comment = "";
                        personSession();
                    } else {
    ...
    private void sendData() {
        ProgressDialogUtil.startLoad(FlowComplainWillDetailActivity.this, "提交数据中");
        new Thread(new Runnable() {
            @Override
            public void run() {
                ...
                final String person1 = tvPerson1.getText().toString() + "";
                final String carNo = tvCarNo.getText().toString() + "";
                final String department = tvComp.getText().toString();
                final String line = tvLine.getText().toString() + "";
                final String shouLi = tvShouLi.getText().toString() + "";
                final String data = tvData.getText().toString() + "";
                final String userCode = new SharedPreferencesHelper(FlowComplainWillDetailActivity.this,
                        "login").getData(FlowComplainWillDetailActivity.this, "userCode", "");
                if (codetemp != null) {
                ...
                if (bigResultList2.size() == 0 && bigResultList1.size() != 0) {
                    Looper.prepare();
                    ProgressDialogUtil.stopLoad();
                    Toast.makeText(FlowComplainWillDetailActivity.this, "请选择审批人", Toast.LENGTH_SHORT).show();
                    Looper.loop();
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 111:
                    ...
                    adapter = new FlowMessageAdapter(FlowComplainWillDetailActivity.this, flowList);
                ...
                case TAG_ONE:
                    ...
                    String word3 = "";
                    if (fkts != null && !fkts.equals("")) {
                        try {
                            JSONArray jsonArray = new JSONArray(fkts);
                    ...
                    String word2 = "";
                    if (aqfy != null && !aqfy.equals("")) {
                        try {
                            JSONArray jsonArray = new JSONArray(aqfy);
                            for (int i = 0; i < jsonArray.length(); i++) {
                                JSONObject jsonObject = jsonArray.getJSONObject(i);
                                if (!jsonObject.getString("v").toString().equals("")) {
                    ...
                    String word1 = "";
                    if (yygs != null && !yygs.equals("")) {
                        try {
                            JSONArray jsonArray = new JSONArray(yygs);
                            for (int i = 0; i < jsonArray.length(); i++) {
                                JSONObject jsonObject = jsonArray.getJSONObject(i);
                                if (!jsonObject.getString("v").toString().equals("")) {
                    ...
                    if (fgsfze != null && !fgsfze.equals("")) {
                        if (tvLeader1.getVisibility() == View.VISIBLE) {
//                            String word1 = "";
//                            try {
//                                JSONArray jsonArray = new JSONArray(fgsfze);
//                                JSONObject jsonObject = jsonArray.getJSONObject(jsonArray.length() - 1);
//                                word1 = jsonObject.getString("v");
//                            } catch (JSONException e) {
//                                e.printStackTrace();
//                            }
                            tvLeader1.setText(fgsfze);
                            etLeader1.setHint(fgsfze);
                        } else {
                            etLeader1.setHint(fgsfze);
                        }
                    }else {
                    ...
                    try {
                        ...
                        bmreout = jsonObject.getString("BuMenFuZeRen");
                        fgreout = jsonObject.getString("FenGongSiChengBanRen");
                        yyreout = jsonObject.getString("bjap");
                        aqreout = jsonObject.getString("aqfwbyj");
                        fkreout = jsonObject.getString("bjpj");
                        if (bmreout.equals("2")) {
                        ...
                        if (bmreout.equals("1") && fgreout.equals("1") && yyreout.equals("1") && aqreout.equals("1") && fkreout.equals("1")) {
                            Toast.makeText(FlowComplainWillDetailActivity.this, "您对当前流程只有读取权限", Toast.LENGTH_SHORT).show();
                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                    ...
                    if (bean.isRevoke()) {
                        Toast.makeText(FlowComplainWillDetailActivity.this, "当前流程已被追回", Toast.LENGTH_SHORT).show();
                    }
                    ProgressDialogUtil.stopLoad();
                    if (beanList.size() == 1) {
                        btnT.setVisibility(View.GONE);
                        tvText.setVisibility(View.GONE);
                        ProgressDialogUtil.startLoad(FlowComplainWillDetailActivity.this, "获取审核人");
                        getAppRovePerson();
                    } else {
                    ...
                    break;
                case TAG_TWO:
                    Toast.makeText(FlowComplainWillDetailActivity.this, "操作失败", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_THERE:
                    Toast.makeText(FlowComplainWillDetailActivity.this, "提交数据成功", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    finish();
                    break;
                case TAG_FOUR:
                ...
                case TAG_SEVEN:
                    ...
                    break;
                case TAG_EIGHT:
                    Toast.makeText(FlowComplainWillDetailActivity.this, "流程已到最后一步，请提交", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
