...
import com.hy.powerplatform.oa_flow.fragment.FragmentCarVideoData;
import com.hy.powerplatform.oa_flow.fragment.FragmentCarVideoList;
 ...
 * 用车流程
 */
public class FlowCarVideoActivity extends BaseActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        header.setTvTitle("车载视频调阅审批单");
        fragment01 = new FragmentCarVideoData();
        fragment02 = new FragmentCarVideoList();
