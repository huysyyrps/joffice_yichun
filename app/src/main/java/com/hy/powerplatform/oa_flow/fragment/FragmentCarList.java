...
import com.hy.powerplatform.oa_flow.activity.FlowUseCarDetailActivity;
...
public class FragmentCarList extends Fragment implements FlowContractPayListAdapter.OnGetAdapterPositionListener,Runnable {
    ...
    public void run() {
        ...
        url = Constant.BASE_URL2 + Constant.MYLIST + start + "&limit=" + limit
                + "&Q_subject_S_LK=" + Constant.USERCARNAME;
    ...
    public void getAdapterPosition(int position) {
        ...
        Intent intent = new Intent(getActivity(), FlowUseCarDetailActivity.class);
