...
import com.hy.powerplatform.oa_flow.activity.FlowOutMessageDetailActivity;
...
public class FragmentOutMessageList extends Fragment implements FlowContractPayListAdapter.OnGetAdapterPositionListener {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                String url = Constant.BASE_URL2 + Constant.MYLIST+start+"&limit="+limit
                        +"&Q_subject_S_LK="+Constant.OUTMESSAGENAME;
    ...
    public void getAdapterPosition(int position) {
        ...
        Intent intent = new Intent(getActivity(), FlowOutMessageDetailActivity.class);
