...
import com.hy.powerplatform.oa_flow.bean.FlowGHPayDetail;
...
public class FlowGHPayDetailActivity extends BaseActivity {
    ...
    protected int provideContentViewId() {
        return R.layout.activity_ghpay_detail;
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.btnHistory:
                ...
                ProgressDialogUtil.startLoad(FlowGHPayDetailActivity.this, "获取数据中");
                new Thread(new Runnable() {
                    @Override
                    public void run() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 111:
                    ...
                    adapter = new FlowMessageAdapter(FlowGHPayDetailActivity.this, flowList);
                    recyclerView.setAdapter(adapter);
                    Toast.makeText(FlowGHPayDetailActivity.this, "查询成功", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_ONE:
                    Gson gson = new Gson();
                    FlowGHPayDetail bean = gson.fromJson(res, FlowGHPayDetail.class);
                    ...
                    String zjl = bean.getMainform().get(0).getGhzx();
                    ...
                    break;
                case TAG_TWO:
                    Toast.makeText(FlowGHPayDetailActivity.this, "获取数据失败，请重试", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_NINE:
                    Gson gson2 = new Gson();
                    ...
                    break;
                case TAG_FIVE:
                    Toast.makeText(FlowGHPayDetailActivity.this, msg.getData().getString("msg"), Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    finish();
                    break;
                case TAG_SIX:
                    Toast.makeText(FlowGHPayDetailActivity.this, "提交数据失败", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
            }
        }
