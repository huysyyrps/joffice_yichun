...
import com.hy.powerplatform.oa_flow.activity.FlowOverTimeWillDetailActivity;
...
public class FragmentOverTimeWillDo extends Fragment implements FlowQingJiaWillDoAdapter.OnGetAdapterPositionListener {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                String url = Constant.BASE_URL2 + Constant.WILLDOLIST + start +
                        "&limit=" + limit+"&Q_subject_S_LK="+Constant.OVERTINENAME;
    ...
    public void getAdapterPosition(int position) {
        Intent intent = new Intent(getActivity(), FlowOverTimeWillDetailActivity.class);
