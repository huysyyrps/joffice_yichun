...
import com.hy.powerplatform.oa_flow.activity.FlowWorkPuechaseWillDetailActivity;
...
public class FragmentWorksPurchaseWillDo extends Fragment implements FlowQingJiaWillDoAdapter.OnGetAdapterPositionListener {
...
//    }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                String url = Constant.BASE_URL2 + Constant.WILLDOLIST + start +
                        "&limit=" + limit+"&Q_subject_S_LK="+Constant.WORKPUECHASENAME;
    ...
    public void getAdapterPosition(int position) {
        Intent intent = new Intent(getActivity(), FlowWorkPuechaseWillDetailActivity.class);
