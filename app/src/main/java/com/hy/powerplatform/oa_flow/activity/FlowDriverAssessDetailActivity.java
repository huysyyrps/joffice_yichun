...
import com.hy.powerplatform.oa_flow.bean.FlowDriverAssessDetail;
...
public class FlowDriverAssessDetailActivity extends BaseActivity {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case TAG_ONE:
                    Gson gson = new Gson();
                    FlowDriverAssessDetail bean = gson.fromJson(res, FlowDriverAssessDetail.class);
                    String person = bean.getMainform().get(0).getXm();
                    String xgfj = bean.getMainform().get(0).getXgfj();
                    ...
                    break;
                case TAG_TWO:
                    Toast.makeText(FlowDriverAssessDetailActivity.this, "获取数据失败，请重试", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_NINE:
                    Gson gson2 = new Gson();
                    ...
                    break;
                case TAG_FIVE:
                    Toast.makeText(FlowDriverAssessDetailActivity.this, msg.getData().getString("msg"), Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    finish();
                    break;
                case TAG_SIX:
                    Toast.makeText(FlowDriverAssessDetailActivity.this, "提交数据失败", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
            }
        }
