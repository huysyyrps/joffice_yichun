...
import com.hy.powerplatform.oa_flow.fragment.FragmentChuCaiData;
import com.hy.powerplatform.oa_flow.fragment.FragmentChuCaiList;
 ...
 * 用车流程
 */
public class FlowChuCaiActivity extends BaseActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        header.setTvTitle("出差申请审批表");
        fragment01 = new FragmentChuCaiData();
        fragment02 = new FragmentChuCaiList();
