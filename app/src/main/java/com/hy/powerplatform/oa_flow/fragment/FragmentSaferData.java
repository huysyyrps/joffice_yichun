...
import com.hy.powerplatform.oa_flow.activity.FlowSaferActivity;
...
import static com.hy.powerplatform.R.id.tvDate;
...
public class FragmentSaferData extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (tag.equals("1")) {
            ...
            tvType4.setVisibility(View.VISIBLE);
        }
        initDatePicker();
    ...
    private void getSenPiPersonOne() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (tag.equals("1")) {
                    data1 = dbA.OAQingJiaMor(url, com.hy.powerplatform.my_utils.base.Constant.SAFER1DIFID);
                } else {
                    data1 = dbA.OAQingJiaMor(url, com.hy.powerplatform.my_utils.base.Constant.SAFER2DIFID);
                }
...
//                }
            ...
            case R.id.btnUp:
                ...
                if (num.equals("") || smallMoney.equals("") || bigMoney.equals("")) {
                    Toast.makeText(getActivity(), "请填写所有数据", Toast.LENGTH_SHORT).show();
                    break;
                }
    ...
    private void UpContractData() {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                final String smallMoney = etSmallMoney.getText().toString();
                final String bigMoney = etBigMoney.getText().toString();
                liushuihao = etLSH.getText().toString();
                String res = dbA.OASaferUp(turl, userDepart, uId, Time,
                        num, smallMoney, bigMoney, userId, userName, liushuihao, tag);
                if (res.equals("")) {
