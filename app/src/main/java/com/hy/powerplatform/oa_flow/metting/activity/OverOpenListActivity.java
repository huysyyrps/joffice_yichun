...
import com.hy.powerplatform.oa_flow.metting.bean.OverOpenList;
...
public class OverOpenListActivity extends BaseActivity {
    ...
    List<OverOpenList.ResultBean> beanList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initDatePicker();
        header.setTvTitle(getResources().getString(R.string.oaflow_metting_rb4));
        httpUtil = OkHttpUtil.getInstance(this);
        LinearLayoutManager manager = new LinearLayoutManager(this);
        recyclerView.getRecyclerView().setLayoutManager(manager);
        baseAdapter = new BaseRecyclerAdapter<OverOpenList.ResultBean>(this, R.layout.adapter_rzlist_item, beanList) {
            @Override
            public void convert(BaseViewHolder holder, final OverOpenList.ResultBean resultBean) {
                ...
                holder.setOnClickListener(R.id.ll, new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(OverOpenListActivity.this, OverOpenDetailActivity.class);
        ...
        customDatePicker1 = new CustomDatePickerDay(this, new CustomDatePickerDay.ResultHandler() {
            ...
            public void handle(String time) { // 回调接口，获得选中的时间
                if (sendHttpContent(time.split(" ")[0])) {
                    ...
                    Toast.makeText(OverOpenListActivity.this, "请选择正确时间", Toast.LENGTH_SHORT).show();
                }
            }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case TAG_ONE:
                    ...
                    Toast.makeText(OverOpenListActivity.this, message, Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_TWO:
                    Bundle b1 = msg.getData();
                    String data = b1.getString("data");
                    OverOpenList bean = new Gson().fromJson(data, OverOpenList.class);
