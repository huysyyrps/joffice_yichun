...
import com.hy.powerplatform.oa_flow.fragment.FragmentFuKuanLiuChengData;
import com.hy.powerplatform.oa_flow.fragment.FragmentFuKuanLiuChengList;
 ...
 * 付款流程审批单
 */
public class FlowFuKuanLiuChengActivity extends BaseActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        header.setTvTitle("付款流程审批单");
        fragment01 = new FragmentFuKuanLiuChengData();
        fragment02 = new FragmentFuKuanLiuChengList();
