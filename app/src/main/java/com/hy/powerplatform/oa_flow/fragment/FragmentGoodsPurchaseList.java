...
import com.hy.powerplatform.oa_flow.activity.FlowGoodsPruchaseDetailActivity;
...
public class FragmentGoodsPurchaseList extends Fragment implements FlowContractPayListAdapter.OnGetAdapterPositionListener {
    ...
    public void getAdapterPosition(int position) {
        ...
        Intent intent = new Intent(getActivity(), FlowGoodsPruchaseDetailActivity.class);
