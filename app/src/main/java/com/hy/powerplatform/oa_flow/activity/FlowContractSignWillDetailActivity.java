...
import com.hy.powerplatform.oa_flow.bean.FlowContractSign;
...
public class FlowContractSignWillDetailActivity extends BaseActivity {
    ...
    @BindView(R.id.llLeaderCB)
    LinearLayout llLeaderCB;
...
//                res = dbA.OAQingJiaWillDoDex(url);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnT:
                ...
                if (beanList.size() != 0) {
                    if (beanList.size() == 1) {
                        ...
                        MyAlertDialog.MyListAlertDialog(FlowContractSignWillDetailActivity.this, namelist, new AlertDialogCallBackP() {
                            @Override
                    ...
                    Toast.makeText(FlowContractSignWillDetailActivity.this, "审批人为空", Toast.LENGTH_SHORT).show();
                }
                break;
            case R.id.tvData:
            ...
            case R.id.btnUp:
                ...
                userName = new SharedPreferencesHelper(FlowContractSignWillDetailActivity.this,
    ...
    private void sendData() {
        ProgressDialogUtil.startLoad(FlowContractSignWillDetailActivity.this, "提交数据中");
        new Thread(new Runnable() {
            @Override
            public void run() {
...
//                    bmjlyj = bean.getMainform().get(0).getBM();
                    ...
                    try {
                        if (formRights != null) {
                            ...
                            if (cbbmreout.equals("2")) {
                                ...
                                llLeaderCB.setVisibility(View.VISIBLE);
                            } else {
                        ...
                        if (csreout.equals("1") && jgreout.equals("1") && flreout.equals("1") && fgreout.equals("1") && zjlreout.equals("1")) {
                            Toast.makeText(FlowContractSignWillDetailActivity.this, "您对当前流程只有读取权限", Toast.LENGTH_SHORT).show();
                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                    ...
                    break;
                case TAG_TWO:
                    Toast.makeText(FlowContractSignWillDetailActivity.this, "操作失败", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_THERE:
                    Toast.makeText(FlowContractSignWillDetailActivity.this, "提交数据成功", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    finish();
                    break;
                case TAG_FOUR:
                ...
                case TAG_SEVEN:
                    ...
                    break;
                case TAG_EIGHT:
                    Toast.makeText(FlowContractSignWillDetailActivity.this, "流程已到最后一步，请提交", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_NINE:
                    Gson gson2 = new Gson();
