...
public class FlowEntryWillDetailActivity extends BaseActivity {
    ...
    String comment = "";
    String selectName;
    String cwreout, yyreout, xxreout, cctreout, zhreout, rlreout, jbbmreout, flowAssignld, ygbhreout, serialNumber = "";//,ygbhreout = ""
    ...
    protected void rightClient() {
        ...
        tv_yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (str.equals("")) {
                    Toast.makeText(FlowEntryWillDetailActivity.this, getResources().getString(R.string.nullify_reason), Toast.LENGTH_SHORT).show();
                } else {
                    dialog.dismiss();
...
//                    }
                ...
                if (ygbhreout.equals("2")) {
                    if (etLeaderNumW.getText().toString().equals("")) {
                        Toast.makeText(FlowEntryWillDetailActivity.this, "员工编号不能为空", Toast.LENGTH_SHORT).show();
                        return;
                    }
                }
            ...
            switch (msg.what) {
                ...
                case TAG_ONE:
                    ...
                    try {
                        ...
                        if (ygbhreout.equals("1") && cwreout.equals("1") && yyreout.equals("1") && xxreout.equals("1")
                                && cctreout.equals("1") && zhreout.equals("1") && rlreout.equals("1") && jbbmreout.equals("1")) {
                            Toast.makeText(FlowEntryWillDetailActivity.this, "您对当前流程只有读取权限", Toast.LENGTH_SHORT).show();
                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                    ...
                    break;
                case TAG_TWO:
                    Toast.makeText(FlowEntryWillDetailActivity.this, "操作失败", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_THERE:
                ...
                case TAG_SEVEN:
                    ...
                    break;
                case TAG_EIGHT:
                    Toast.makeText(FlowEntryWillDetailActivity.this, "流程已到最后一步，请提交", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_NINE:
                    Gson gson2 = new Gson();
