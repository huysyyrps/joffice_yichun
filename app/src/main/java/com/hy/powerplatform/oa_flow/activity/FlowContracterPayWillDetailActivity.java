...
import com.hy.powerplatform.oa_flow.bean.FlowContracterPayWillDetail;
...
public class FlowContracterPayWillDetailActivity extends BaseActivity {
    ...
    private String name, taskId, res, fullnameUId, fullname, bmfzr, fgfze, fgcwze, zjl = "";
    ...
    List<FlowContracterPayWillDetail.TransBean> beanList = new ArrayList<>();
    ...
    protected int provideContentViewId() {
        return R.layout.activity_flow_contracter_pay_detail;
    }
    ...
    protected void rightClient() {
        ...
        tv_yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (str.equals("")) {
                    Toast.makeText(FlowContracterPayWillDetailActivity.this, getResources().getString(R.string.nullify_reason), Toast.LENGTH_SHORT).show();
                } else {
                    dialog.dismiss();
                    ProgressDialogUtil.startLoad(FlowContracterPayWillDetailActivity.this, getResources().getString(R.string.get_data));
...
//                res = dbA.OAQingJiaWillDoDex(url);
    ...
    @OnClick({R.id.btnNO, R.id.tvData, R.id.btnT, R.id.btnHistory, R.id.llShenPiRen})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnHistory:
                ...
                ProgressDialogUtil.startLoad(FlowContracterPayWillDetailActivity.this, "获取数据中");
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        //String name =URLDecoder.decode(待转值,"utf-8");
            ...
            case R.id.btnT:
                ...
                if (beanList.size() != 0) {
                    if (beanList.size() == 1) {
                        ...
                        MyAlertDialog.MyListAlertDialog(FlowContracterPayWillDetailActivity.this, namelist, new AlertDialogCallBackP() {
                            @Override
                    ...
                    Toast.makeText(FlowContracterPayWillDetailActivity.this, "审批人为空", Toast.LENGTH_SHORT).show();
                }
                break;
            case R.id.tvData:
            ...
            case R.id.btnNO:
                ...
                fgcwze = bean.getMainform().get(0).getFgcwldyj();
    ...
    private void sendData() {
        ProgressDialogUtil.startLoad(FlowContracterPayWillDetailActivity.this, "提交数据中");
        new Thread(new Runnable() {
            @Override
            public void run() {
                String department = tvClass.getText().toString();
                String person = tvJingBanRen.getText().toString();
                String name = tvContractName.getText().toString();
                String time = tvTime.getText().toString();
                String situation = tvSituation.getText().toString();
                final String userCode = new SharedPreferencesHelper(FlowContracterPayWillDetailActivity.this,
                        "login").getData(FlowContracterPayWillDetailActivity.this, "userCode", "");
                if (codetemp != null) {
                ...
                if (bigResultList.size() == 0 && bigResultList1.size() != 0) {
                    Looper.prepare();
                    ProgressDialogUtil.stopLoad();
                    Toast.makeText(FlowContracterPayWillDetailActivity.this, "请选择审批人", Toast.LENGTH_SHORT).show();
                    Looper.loop();
                } else {
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 333:
                    ProgressDialogUtil.stopLoad();
                    Toast.makeText(FlowContracterPayWillDetailActivity.this, getResources().getString(R.string.c_success), Toast.LENGTH_SHORT).show();
                    finish();
                    break;
                case 444:
                    ProgressDialogUtil.stopLoad();
                    Toast.makeText(FlowContracterPayWillDetailActivity.this, getResources().getString(R.string.c_false), Toast.LENGTH_SHORT).show();
                    break;
                case 111:
                    Gson gsonF = new Gson();
                    ...
                    adapter = new FlowMessageAdapter(FlowContracterPayWillDetailActivity.this, flowList);
                ...
                case TAG_ONE:
                    ...
                    String person = bean.getMainform().get(0).getJbr();
                    ...
                    serialNumber = bean.getMainform().get(0).getHtbh();
                    ...
                    try {
                        ...
                        fgcwreout = jsonObject.getString("fgcwldyj");
                        ...
                        if (bmreout.equals("1") && fgreout.equals("1") && fgcwreout.equals("1") && zjlreout.equals("1")) {
                            Toast.makeText(FlowContracterPayWillDetailActivity.this, "您对当前流程只有读取权限", Toast.LENGTH_SHORT).show();
                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }

                    tvJingBanRen.setText(person);
                    ...
                    if (bean.isRevoke()) {
                        Toast.makeText(FlowContracterPayWillDetailActivity.this, "当前流程已被追回", Toast.LENGTH_SHORT).show();
                    }
                    ProgressDialogUtil.stopLoad();
                    if (beanList.size() == 1) {
                        btnT.setVisibility(View.GONE);
                        tvText.setVisibility(View.GONE);
                        ProgressDialogUtil.startLoad(FlowContracterPayWillDetailActivity.this, "获取审核人");
                        getAppRovePerson();
                    }
                    break;
                case TAG_TWO:
                    Toast.makeText(FlowContracterPayWillDetailActivity.this, "操作数据失败", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_THERE:
                    Toast.makeText(FlowContracterPayWillDetailActivity.this, "提交数据成功", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    finish();
                    break;
                case TAG_FOUR:
                ...
                case TAG_SEVEN:
                    ...
                    break;
                case TAG_EIGHT:
                    Toast.makeText(FlowContracterPayWillDetailActivity.this, "流程已到最后一步，请提交", Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_NINE:
                    Gson gson2 = new Gson();
