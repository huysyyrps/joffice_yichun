...
import com.hy.powerplatform.oa_flow.activity.FlowPuechaseWillDetailActivity;
...
import static com.hy.powerplatform.my_utils.base.Constant.PUECHASEFLOWNAME;
...
public class FragmentPurchaseWillDo extends Fragment implements FlowQingJiaWillDoAdapter.OnGetAdapterPositionListener {
...
//        recyclerView.setLoadMoreEnable(false);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                String url = Constant.BASE_URL2 + Constant.WILLDOLIST + start +
                        "&limit=" + limit+"&Q_subject_S_LK="+PUECHASEFLOWNAME;
    ...
    public void getAdapterPosition(int position) {
        Intent intent = new Intent(getActivity(), FlowPuechaseWillDetailActivity.class);
