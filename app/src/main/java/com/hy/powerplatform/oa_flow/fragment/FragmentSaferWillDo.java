...
import com.hy.powerplatform.oa_flow.activity.FlowSaferWillDetailActivity;
...
public class FragmentSaferWillDo extends Fragment implements FlowQingJiaWillDoAdapter.OnGetAdapterPositionListener,Runnable {
...
//        recyclerView.setLoadMoreEnable(false);
    ...
    public void run() {
        ...
        if (tag.equals("1")){
            url = Constant.BASE_URL2 + Constant.WILLDOLIST + start +
                    "&limit=" + limit+"&Q_subject_S_LK="+Constant.SAFERNAMES;
        }else {
            url = Constant.BASE_URL2 + Constant.WILLDOLIST + start +
                    "&limit=" + limit+"&Q_subject_S_LK="+Constant.SAFERNAMEY;
        }
    ...
    public void getAdapterPosition(int position) {
        Intent intent = new Intent(getActivity(), FlowSaferWillDetailActivity.class);
