...
import com.hy.powerplatform.oa_flow.activity.FlowJSGCWillDetailActivity;
...
public class FragmentJSGCWillDo extends Fragment implements FlowQingJiaWillDoAdapter.OnGetAdapterPositionListener,Runnable {
...
//        recyclerView.setLoadMoreEnable(false);
    ...
    public void run() {
        String url = Constant.BASE_URL2 + Constant.WILLDOLIST + start +
                "&limit=" + limit+"&Q_subject_S_LK="+Constant.JSGCNAME;
    ...
    public void getAdapterPosition(int position) {
        Intent intent = new Intent(getActivity(), FlowJSGCWillDetailActivity.class);
