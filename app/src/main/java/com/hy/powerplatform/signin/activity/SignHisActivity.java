...
public class SignHisActivity extends BaseActivity implements SignInHisView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signInHisPresenter = new SignInHisPresenterimpl(this, this);
    ...
    private void sendHttpContent() {
        ...
        if (startTime.getTime() > endTime.getTime()) {
            ...
            signInHisPresenter.getSignInHisPresenterData(tvStartTime.getText().toString(),
    ...
    public void getSignInHisData(SignHis signHis) {
        ...
        if (hisList.size() == 0) {
            ...
            adapter = new SignHisAdapter(this, hisList);
