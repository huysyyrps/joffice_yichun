...
public class WeiZhangListActivity extends BaseActivity {
    ...
    List<WeiZhangList.ResultBean> beanList = new ArrayList<>();
    private CustomDatePickerDay customDatePicker1, customDatePicker2;
    String userName = "", profileId = "", busName = "", busCode = "",userCode = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        baseAdapter = new BaseRecyclerAdapter<WeiZhangList.ResultBean>(this, R.layout.adapter_rzlist_item, beanList) {
            @Override
            public void convert(BaseViewHolder holder, final WeiZhangList.ResultBean resultBean) {
                holder.setText(R.id.tv1, "车牌号");
                holder.setText(R.id.tvName, resultBean.getCarNo());
                holder.setText(R.id.tv2, "驾驶员");
                holder.setText(R.id.tvPhone, resultBean.getDriverName());
                holder.setText(R.id.tv3, "违章项目");
                holder.setText(R.id.tvIdCard, resultBean.getVnProject());
                holder.setOnClickListener(R.id.ll, new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(WeiZhangListActivity.this, WeiZhangDetailActivity.class);
    ...
    protected int provideContentViewId() {
        return R.layout.activity_wei_zhang_list;
    }
    ...
    private void getData(final int start, final int limit) {
        ...
        final String path_url = Constant.BASE_URL2 + Constant.WEIZHANG + "?start=" + start + "&limit=" + limit;
        map.clear();
        map.put("Q_carNo_S_EQ", busName);
        map.put("Q_driverCode_S_EQ", userCode);
        map.put("ks", tvStartTime1.getText().toString());
        map.put("js", tvEndTime1.getText().toString());
        ...
        customDatePicker1 = new CustomDatePickerDay(this, new CustomDatePickerDay.ResultHandler() {
            ...
            public void handle(String time) { // 回调接口，获得选中的时间
                if (sendHttpContent(time.split(" ")[0])) {
                    ...
                    Toast.makeText(WeiZhangListActivity.this, "请选择正确时间", Toast.LENGTH_SHORT).show();
                }
            }
...
//            Toast.makeText(this, "请选择正确时间", Toast.LENGTH_SHORT).show();
    ...
    @OnClick({R.id.tvCarName, R.id.tvDriver, R.id.tvStartTime1, R.id.tvEndTime1})
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case TAG_ONE:
                    ...
                    Toast.makeText(WeiZhangListActivity.this, message, Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_TWO:
                    Bundle b1 = msg.getData();
                    String data = b1.getString("data");
                    WeiZhangList bean = new Gson().fromJson(data, WeiZhangList.class);
