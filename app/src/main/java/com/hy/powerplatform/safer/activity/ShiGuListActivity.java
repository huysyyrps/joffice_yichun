...
public class ShiGuListActivity extends BaseActivity {
    ...
    List<ShiGuList.ResultBean> beanList = new ArrayList<>();
            ...
            public void convert(BaseViewHolder holder, final ShiGuList.ResultBean resultBean) {
                ...
                holder.setOnClickListener(R.id.ll, new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(ShiGuListActivity.this, ShiGuDetailActivity.class);
    ...
    private void getData(final int start, final int limit) {
        ...
        final String path_url = Constant.BASE_URL2 + Constant.SHIGUDANGAN + "?start=" + start + "&limit=" + limit;
        map.clear();
        map.put("Q_carNo_S_EQ", busName);
        map.put("Q_driverName_S_EQ", userName);
        map.put("Q_atAtDate_S_GE", tvStartTime1.getText().toString());
        map.put("Q_atAtDate_S_LE", tvEndTime1.getText().toString());
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case TAG_ONE:
                    ...
                    Toast.makeText(ShiGuListActivity.this, message, Toast.LENGTH_SHORT).show();
                    ProgressDialogUtil.stopLoad();
                    break;
                case TAG_TWO:
                    Bundle b1 = msg.getData();
                    String data = b1.getString("data");
                    ShiGuList bean = new Gson().fromJson(data, ShiGuList.class);
