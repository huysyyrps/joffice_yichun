...
public class ShiGuHisFragment extends Fragment {
...
//    @Override
//    public void getHisViewData(ShiGuHis shiGuHis) {
//        for (int i = 0; i < shiGuHis.getResult().size(); i++) {
//            hisList.add(shiGuHis.getResult().get(i));
//        }
//        if (hisList.size() == 0){
//            imageView.setVisibility(View.VISIBLE);
//            recyclerView.setVisibility(View.GONE);
