...
public class InspectAllJNAdapter extends RecyclerView.Adapter<InspectAllJNAdapter.ViewHolder> {
    Context context;
    ...
    public void setOnInnerItemOnClickListener(GetJNItemPosition getJNItemPosition){
        this.getJNItemPosition=getJNItemPosition;
    }

    public InspectAllJNAdapter(Context context, List<String> anquanList) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.tvGet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getJNItemPosition.getJNPosition(position,"photo");
            }
        });
        holder.llPass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getJNItemPosition.getJNPosition(position,"pass");
            }
        });
        ...
        holder.llNoPass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getJNItemPosition.getJNPosition(position,"nopass");
            }
        });
    }
