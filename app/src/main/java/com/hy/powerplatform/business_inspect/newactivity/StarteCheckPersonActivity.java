...
import com.hy.powerplatform.business_inspect.presenter.carcodepresenterimpl.HealthCheckPersonPresenterimpl;
...
public class StarteCheckPersonActivity extends BaseActivity implements CheckPersonView,CheckOnePersonAdapter.CallBackPosition{
    ...
    HealthCheckPersonPresenterimpl checkPersonPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkPersonPresenter = new HealthCheckPersonPresenterimpl(this,this);
...
//        }
        ...
        userCode = checkList.get(position).getUserCode();
        Intent i = new Intent();
        i.putExtra("name", name);
        i.putExtra("profileId", userCode);
        setResult(Constant.TAG_SIX, i);
        finish();
    }
}
