...
import com.hy.powerplatform.business_inspect.model.carcodemodelimpl.KillCheckPersonModelimpl;
...
public class KillCheckPersonPresenterimpl implements CheckPersonPresenter {

    Context context;
    CheckPersonModel checkPersonModel;
    CheckPersonView checkPersonView;

    public KillCheckPersonPresenterimpl(CheckPersonView checkPersonView, Context context){
        this.context = context;
        this.checkPersonView = checkPersonView;
        checkPersonModel = new KillCheckPersonModelimpl();
    }
