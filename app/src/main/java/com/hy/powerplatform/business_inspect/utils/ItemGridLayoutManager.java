...
import com.hy.powerplatform.business_inspect.adapter.ShiGuAdapter;
...
public class ItemGridLayoutManager extends GridLayoutManager {
     ...
     */
    public ItemGridLayoutManager(Context context, int spanCount, ShiGuAdapter adapter, final RecyclerView recyclerView) {
