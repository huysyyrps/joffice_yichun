...
public class InspectAllGFAdapter extends RecyclerView.Adapter<InspectAllGFAdapter.ViewHolder> {
    Context context;
    ...
    public void setOnInnerItemOnClickListener(GetGFItemPosition getGFItemPosition){
        this.getGFItemPosition=getGFItemPosition;
    }

    public InspectAllGFAdapter(Context context, List<String> anquanList) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.tvGet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getGFItemPosition.getGFPosition(position,"photo");
            }
        });
        holder.llPass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getGFItemPosition.getGFPosition(position,"pass");
            }
        });
        ...
        holder.llNoPass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getGFItemPosition.getGFPosition(position,"nopass");
            }
        });
    }
