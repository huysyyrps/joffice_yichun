...
public class SelectInspectDrivePAdapter extends RecyclerView.Adapter<SelectInspectDrivePAdapter.ViewHolder> {

    private List<DriverP.DataBean> beanList = new ArrayList<>();
    ...
    public SelectInspectDrivePAdapter(List<DriverP.DataBean> showMDeptList){
