...
import com.hy.powerplatform.business_inspect.fragment.AllNoPassFragment;
import com.hy.powerplatform.business_inspect.fragment.AllPassFragment;
...
public class InspectAllActivity extends BaseActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentPass = new AllPassFragment();
        fragmentNoPass = new AllNoPassFragment();
    ...
    protected int provideContentViewId() {
        return R.layout.activity_inspectall;
    }
