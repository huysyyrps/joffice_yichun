...
import com.hy.powerplatform.business_inspect.fragment.HealthNoPassFragment;
import com.hy.powerplatform.business_inspect.fragment.HealthPassFragment;
...
public class InspectHealthActivity extends BaseActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentPass = new HealthPassFragment();
        fragmentNoPass = new HealthNoPassFragment();
    ...
    protected int provideContentViewId() {
        return R.layout.activity_inspecthealth;
    }
