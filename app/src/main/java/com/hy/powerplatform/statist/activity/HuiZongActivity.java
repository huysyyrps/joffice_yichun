...
import com.hy.powerplatform.statist.bean.HuiZong;
...
public class HuiZongActivity extends BaseActivity {
    ...
    List<HuiZong> beanList = new ArrayList<>();
    //并内显示文字
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        header.setTvTitle(getResources().getString(R.string.oaflow_statist_rb5));
        initDatePicker();
        httpUtil = OkHttpUtil.getInstance(this);
        LinearLayoutManager manager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(manager);
        mAdapter = new BaseRecyclerAdapterPosition<HuiZong>(this, R.layout.adapter_data_item, beanList) {
            @Override
            public void convert(BaseViewHolderPosition holder, final HuiZong itemBean, int position) {
                holder.setText(R.id.tvName, itemBean.getYSYHMXB_Fuel());
                holder.setText(R.id.tvData, itemBean.getYSYHMXB_ZJE());
                if (position % 2 != 0) {
    ...
    private void getData() {
        ...
        final String path_url = Constant.BASE_URL2 + Constant.HUIZONG;
        map.clear();
...
//      mChart.setOnAnimationListener(this);
        //饼状图中间的文字
        pieChart.setCenterText(getResources().getString(R.string.oaflow_statist_rb5));
        //设置数据
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case TAG_ONE:
                    ...
                    Toast.makeText(HuiZongActivity.this, message, Toast.LENGTH_SHORT).show();
                ...
                case TAG_TWO:
                    ...
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            bean.setYSYHMXB_Fuel(jsonObject.getString("YSYHMXB_Fuel"));
                            bean.setYSYHMXB_ZJE(jsonObject.getString("YSYHMXB_ZJE"));
                            beanList.add(bean);
                            xValues.add(jsonObject.getString("YSYHMXB_Fuel"));
                            yValues.add(new Entry(Float.valueOf(jsonObject.getString("YSYHMXB_ZJE")), i));
                        }
                        //y轴的集合
