...
import com.hy.powerplatform.statist.bean.YingYunShouRu;
...
public class YingYunShouRuActivity extends BaseActivity {
...
//      mLegend.setForm(LegendForm.LINE);  //设置比例图的形状，默认是方形
    ...
    private void getData() {
        ...
        final String path_url = Constant.BASE_URL2 + Constant.YINGYUNSHOURU;
        map.clear();
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case TAG_ONE:
                    ...
                    Toast.makeText(YingYunShouRuActivity.this, message, Toast.LENGTH_SHORT).show();
